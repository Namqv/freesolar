!function(e, t) {
    ...
    E.extend = E.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = e[t],
                    "__proto__" !== t && o !== n && (c && n && (E.isPlainObject(n) || (s = Array.isArray(n))) ? (i = o[t],
                    r = s && !Array.isArray(i) ? [] : s || E.isPlainObject(i) ? i : {},
                    s = !1,
                    o[t] = E.extend(c, r, n)) : void 0 !== n && (o[t] = n));
        return o
    }
    ,
    E.extend({
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (p(Object(e)) ? E.merge(i, "string" == typeof e ? [e] : e) : l.call(i, e)),
            i
        },
    ...
    var f = function(i) {
        ...
        var e, p, w, r, o, f, h, m, x, l, c, T, C, a, S, g, u, v, b, E = "sizzle" + 1 * new Date, y = i.document, k = 0, n = 0, $ = le(), M = le(), P = le(), I = le(), A = function(e, t) {
            return e === t && (c = !0),
            0
        }, D = {}.hasOwnProperty, t = [], _ = t.pop, L = t.push, z = t.push, O = t.slice, N = function(e, t) {
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", B = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", j = "\\[" + B + "*(" + F + ")(?:" + B + "*([*^$|!~]?=)" + B + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + B + "*\\]", q = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + j + ")*)|.*)\\)|)", R = new RegExp(B + "+","g"), V = new RegExp("^" + B + "+|((?:^|[^\\\\])(?:\\\\.)*)" + B + "+$","g"), W = new RegExp("^" + B + "*," + B + "*"), Y = new RegExp("^" + B + "*([>+~]|" + B + ")" + B + "*"), X = new RegExp(B + "|>"), G = new RegExp(q), U = new RegExp("^" + F + "$"), K = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + j),
        ...
        }, Z = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ie = /[+~]/, ne = new RegExp("\\\\([\\da-f]{1,6}" + B + "?|(" + B + ")|.)","ig"), se = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, re = function(e, t) {
        ...
        try {
            z.apply(t = O.call(y.childNodes), y.childNodes),
        ...
        function ae(e, t, i, n) {
            var s, r, o, a, l, c, u, d = t && t.ownerDocument, h = t ? t.nodeType : 9;
            if (i = i || [],
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return i;
            if (!n && ((t ? t.ownerDocument || t : y) !== C && T(t),
            t = t || C,
            S)) {
                if (11 !== h && (l = te.exec(e)))
                    if (s = l[1]) {
                        if (9 === h) {
                            ...
                            if (o.id === s)
                                return i.push(o),
                                i
                        } else if (d && (o = d.getElementById(s)) && b(t, o) && o.id === s)
                            return i.push(o),
                            i
                    } else {
                        if (l[2])
                ...
                if (p.qsa && !I[e + " "] && (!g || !g.test(e)) && (1 !== h || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    d = t,
                    1 === h && X.test(e)) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(se, re) : t.setAttribute("id", a = E),
                        r = (c = f(e)).length; r--; )
                            c[r] = "#" + a + " " + ye(c[r]);
                        u = c.join(","),
                        d = ie.test(e) && ve(t.parentNode) || t
                    }
                    try {
        ...
        function ge(o) {
            return ce(function(r) {
                return r = +r,
                ce(function(e, t) {
                    for (var i, n = o([], e.length, r), s = n.length; s--; )
                        e[i = n[s]] && (e[i] = !(t[i] = e[i]))
                })
            })
        }
        ...
        T = ae.setDocument = function(e) {
            ...
            return n !== C && 9 === n.nodeType && n.documentElement && (a = (C = n).documentElement,
            S = !o(C),
            y !== C && (i = C.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", s, !1) : i.attachEvent && i.attachEvent("onunload", s)),
            ...
            u = [],
            g = [],
            (p.qsa = ee.test(C.querySelectorAll)) && (ue(function(e) {
                ...
                e.querySelectorAll("[selected]").length || g.push("\\[" + B + "*(?:value|" + H + ")"),
            ...
            b = t || ee.test(a.contains) ? function(e, t) {
            ...
            : function(e, t) {
                ...
                if (!s || !r)
                    return e === C ? -1 : t === C ? 1 : s ? -1 : r ? 1 : l ? N(l, e) - N(l, t) : 0;
                if (s === r)
                    return he(e, t);
        ...
        ae.matchesSelector = function(e, t) {
            ...
            p.matchesSelector && S && !I[t + " "] && (!u || !u.test(t)) && (!g || !g.test(t)))
                try {
                    var i = v.call(e, t);
        ...
        (w = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, i = !e[6] && e[2];
                    return K.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && G.test(i) && (t = f(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t),
                    e[2] = i.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(i, n, s) {
                    return function(e) {
                        var t = ae.attr(e, i);
                        return null == t ? "!=" === n : !n || (t += "",
                        "=" === n ? t === s : "!=" === n ? t !== s : "^=" === n ? s && 0 === t.indexOf(s) : "*=" === n ? s && -1 < t.indexOf(s) : "$=" === n ? s && t.slice(-s.length) === s : "~=" === n ? -1 < (" " + t.replace(R, " ") + " ").indexOf(s) : "|=" === n && (t === s || t.slice(0, s.length + 1) === s + "-"))
                    }
                },
                CHILD: function(f, e, t, m, g) {
                    ...
                    : function(e, t, i) {
                        var n, s, r, o, a, l, c = v != b ? "nextSibling" : "previousSibling", u = e.parentNode, d = y && e.nodeName.toLowerCase(), h = !i && !y, p = !1;
                        if (u) {
                            if (v) {
                                for (; c; ) {
                                    for (o = e; o = o[c]; )
                            ...
                            b && h) {
                                for (p = (a = (n = (s = (r = (o = u)[E] || (o[E] = {}))[o.uniqueID] || (r[o.uniqueID] = {}))[f] || [])[0] === k && n[1]) && n[2],
                                o = a && u.childNodes[a]; o = ++a && o && o[c] || (p = a = 0) || l.pop(); )
                                    if (1 === o.nodeType && ++p && o === e) {
                                        s[f] = [k, a, p];
                                        break
                                    }
                            } else if (h && (p = a = (n = (s = (r = (o = e)[E] || (o[E] = {}))[o.uniqueID] || (r[o.uniqueID] = {}))[f] || [])[0] === k && n[1]),
                            !1 === p)
                                for (; (o = ++a && o && o[c] || (p = a = 0) || l.pop()) && ((y ? o.nodeName.toLowerCase() !== d : 1 !== o.nodeType) || !++p || (h && ((s = (r = o[E] || (o[E] = {}))[o.uniqueID] || (r[o.uniqueID] = {}))[f] = [k, p]),
                                o !== e)); )
                                    ;
                ...
                PSEUDO: function(e, r) {
                    ...
                    w.setFilters.hasOwnProperty(e.toLowerCase()) ? ce(function(e, t) {
                        for (var i, n = o(e, r), s = n.length; s--; )
                            e[i = N(e, n[s])] = !(t[i] = n[s])
                    }) : function(e) {
                        return o(e, 0, t)
                    }
            ...
            pseudos: {
                not: ce(function(e) {
                    ...
                    return a[E] ? ce(function(e, t, i, n) {
                        for (var s, r = a(e, null, n, []), o = e.length; o--; )
                            (s = r[o]) && (e[o] = !(t[o] = s))
                    }) : function(e, t, i) {
                        return n[0] = e,
                        a(n, null, i, s),
                ...
                lang: ce(function(i) {
                    return U.test(i || "") || ae.error("unsupported lang: " + i),
        ...
        function we(a, e, t) {
            ...
            : function(e, t, i) {
                ...
                if (i) {
                    for (; e = e[l]; )
                        if ((1 === e.nodeType || d) && a(e, t, i))
                            return !0
                } else
                    for (; e = e[l]; )
                        if (1 === e.nodeType || d)
                            if (s = (r = e[E] || (e[E] = {}))[e.uniqueID] || (r[e.uniqueID] = {}),
            ...
            ce(function(e, t, i, n) {
                var s, r, o, a = [], l = [], c = t.length, u = e || function(e, t, i) {
                    for (var n = 0, s = t.length; n < s; n++)
                        ae(e, t[n], i);
                    return i
                }(f || "*", i.nodeType ? [i] : i, []), d = !p || !e && f ? u : Te(u, a, p, i, n), h = m ? v || (e ? p : c || g) ? [] : t : d;
                if (m && m(d, h, i, n),
                g)
                    for (s = Te(h, l),
                    g(s, [], i, n),
                ...
                if (e) {
                    if (v || p) {
                        ...
                        for (r = h.length; r--; )
                            (o = h[r]) && -1 < (s = v ? N(e, o) : a[r]) && (e[s] = !(t[s] = o))
                    }
                } else
                    h = Te(h === t ? h.splice(c, h.length) : h),
                    v ? v(null, t, h, n) : z.apply(t, h)
            })
        }
        function Se(e) {
        ...
        return be.prototype = w.filters = w.pseudos,
        w.setFilters = new be,
        f = ae.tokenize = function(e, t) {
            ...
            a = [],
            l = w.preFilter; o; ) {
                for (r in i && !(n = W.exec(o)) || (n && (o = o.slice(n[0].length) || o),
                a.push(s = [])),
                i = !1,
                (n = Y.exec(o)) && (i = n.shift(),
                s.push({
                    value: i,
                    type: n[0].replace(V, " ")
                }),
                o = o.slice(i.length)),
                w.filter)
                    !(n = K[r].exec(o)) || l[r] && !(n = l[r](n)) || (i = n.shift(),
                    s.push({
                        value: i,
                        type: r,
                        matches: n
        ...
        h = ae.compile = function(e, t) {
            var i, g, v, b, y, n, s = [], r = [], o = P[e + " "];
            if (!o) {
                for (i = (t = t || f(e)).length; i--; )
                    (o = Se(t[i]))[E] ? s.push(o) : r.push(o);
                (o = P(e, (g = r,
                b = 0 < (v = s).length,
                y = 0 < g.length,
                n = function(e, t, i, n, s) {
                    var r, o, a, l = 0, c = "0", u = e && [], d = [], h = x, p = e || y && w.find.TAG("*", s), f = k += null == h ? 1 : Math.random() || .1, m = p.length;
                    ...
                    b && c !== l) {
                        ...
                        if (e) {
                            if (0 < l)
                                for (; c--; )
                                    u[c] || d[c] || (d[c] = _.call(n));
                            d = Te(d)
                        }
                        z.apply(n, d),
                        s && !e && 0 < d.length && 1 < l + v.length && ae.uniqueSort(n)
                    }
                    return s && (k = f,
                    x = h),
                    u
        ...
        m = ae.select = function(e, t, i, n) {
            var s, r, o, a, l, c = "function" == typeof e && e, u = !n && f(e = c.selector || e);
            if (i = i || [],
            1 === u.length) {
                ...
                for (s = K.needsContext.test(e) ? 0 : r.length; s-- && (o = r[s],
                !w.relative[a = o.type]); )
            ...
            return (c || h(e, u))(n, t, !S, i, !t || ie.test(e) && ve(t.parentNode) || t),
            i
        }
        ,
        p.sortStable = E.split("").sort(A).join("") === E,
    ...
    (E.fn.init = function(e, t, i) {
        ...
        return (s = S.getElementById(n[2])) && (this[0] = s,
        this.length = 1),
        this
    }
    ).prototype = E.fn,
    ...
    E.fn.extend({
        ...
        closest: function(e, t) {
            var i, n = 0, s = this.length, r = [], o = "string" != typeof e && E(e);
            if (!$.test(e))
                for (; n < s; n++)
    ...
    E.each({
        ...
        E.fn[n] = function(e, t) {
            ...
            t && "string" == typeof t && (i = E.filter(t, i)),
            1 < this.length && (L[n] || E.uniqueSort(i),
            _.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
        ...
        function s() {
            ...
            o = r = !0; c.length; u = -1)
                for (t = c.shift(); ++u < l.length; )
                    !1 === l[u].apply(t[0], t[1]) && n.stopOnFalse && (u = l.length,
                    t = !1);
            n.memory || (t = !1),
            r = !1,
            a && (l = t ? [] : "")
        }
        var r, t, o, a, l = [], c = [], u = -1, d = {
            add: function() {
    ...
    E.extend({
              ...
              , o = {
                ...
                then: function(t, i, n) {
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(s < l)) {
                                    ...
                                    y(t) ? a ? t.call(e, c(l, r, N, a), c(l, r, H, a)) : (l++,
                                    t.call(e, c(l, r, N, a), c(l, r, H, a), c(l, r, N, r.notifyWith))) : (o !== N && (i = void 0,
                                    n = [e]),
                                    (a || r.resolveWith)(i, n))
                                }
                            }
                    ...
                    return E.Deferred(function(e) {
                        r[0][3].add(c(0, e, y(n) ? n : N, e.notifyWith)),
                        r[1][3].add(c(0, e, y(t) ? t : N)),
                        r[2][3].add(c(0, e, y(i) ? i : H))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            var i = arguments.length
              ...
              , r = a.call(arguments)
              , o = E.Deferred();
            if (i <= 1 && (B(e, o.done(t(n)).resolve, o.reject, !i),
    ...
    E.ready.then = j.then,
    "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? C.setTimeout(E.ready) : (S.addEventListener("DOMContentLoaded", q),
        ...
        data: function(i, e) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var t;
                    if (r && void 0 === e)
                        return void 0 !== (t = Z.get(r, i)) ? t : void 0 !== (t = ee(r, i)) ? t : void 0;
                    this.each(function() {
                        Z.set(this, i, e)
                    })
            ...
            1 === r.nodeType && !K.get(r, "hasDataAttrs"))) {
                for (t = o.length; t--; )
                    o[t] && 0 === (n = o[t].name).indexOf("data-") && (n = X(n.slice(5)),
                    ee(r, n, s[n]));
    ...
    E.extend({
        queue: function(e, t, i) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                n = K.get(e, t),
                i && (!n || Array.isArray(i) ? n = K.access(e, t, E.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    E.fn.extend({
        ...
        promise: function(e, t) {
            ...
            var n, s = 1, r = E.Deferred(), o = this, a = this.length;
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; a--; )
                (n = K.get(o[a], e + "queueHooks")) && n.empty && (s++,
                n.empty.add(i));
            return i(),
            r.promise(t)
        }
    ...
    function ce(e, t, i, n) {
        ...
        , l = a(), c = i && i[3] || (E.cssNumber[t] ? "" : "px"), u = e.nodeType && (E.cssNumber[t] || "px" !== c && +l) && ie.exec(E.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; o--; )
    ...
    var ue = {};
    function de(e, t) {
        for (var i, n, s, r, o, a, l, c = [], u = 0, d = e.length; u < d; u++)
            (n = e[u]).style && (i = n.style.display,
            t ? ("none" === i && (c[u] = K.get(n, "display") || null,
            c[u] || (n.style.display = "")),
            "" === n.style.display && ae(n) && (c[u] = (l = o = r = void 0,
            o = (s = n).ownerDocument,
            a = s.nodeName,
            (l = ue[a]) || (r = o.body.appendChild(o.createElement(a)),
            l = E.css(r, "display"),
            r.parentNode.removeChild(r),
            "none" === l && (l = "block"),
            ue[a] = l)))) : "none" !== i && (c[u] = "none",
            K.set(n, "display", i)));
        for (u = 0; u < d; u++)
    ...
    function ge(e, t) {
        ...
        void 0 === t || t && M(e, t) ? E.merge([e], i) : i
    }
    function ve(e, t) {
        for (var i = 0, n = e.length; i < n; i++)
    ...
    be.appendChild(ye),
    b.checkClone = be.cloneNode(!0).cloneNode(!0).lastChild.checked,
    be.innerHTML = "<textarea>x</textarea>",
    b.noCloneChecked = !!be.cloneNode(!0).lastChild.defaultValue;
    var Te = /^key/
        ...
        E.event.add(e, s, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[s]) {
                    if (n.length)
                        (E.event.special[s] || {}).delegateType && e.stopPropagation();
                    else if (n = a.call(arguments),
                    K.set(this, s, n),
                    t = r(this, s),
                    this[s](),
                    n !== (i = K.get(this, s)) || t ? K.set(this, s, !1) : i = {},
                    n !== i)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        i.value
                } else
                    n.length && (K.set(this, s, {
    ...
    E.event = {
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(O) || [""]).length; c--; )
                    ...
                    p) {
                        ...
                        o = r = h.length; r--; )
                            u = h[r],
                            !s && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (h.splice(r, 1),
                            u.selector && h.delegateCount--,
                            d.remove && d.remove.call(e, u));
                        o && !h.length && (d.teardown && !1 !== d.teardown.call(e, f, g.handle) || E.removeEvent(e, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            E.event.remove(e, p + t[c], i, n, !0);
                E.isEmptyObject(l) && K.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, i, n, s, r, o, a = E.event.fix(e), l = new Array(arguments.length), c = (K.get(this, "events") || {})[a.type] || [], u = E.event.special[a.type] || {};
            for (l[0] = a,
            t = 1; t < arguments.length; t++)
                l[t] = arguments[t];
            if (a.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (o = E.event.handlers.call(this, a, c),
                t = 0; (s = o[t++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (r = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = r.data,
                        void 0 !== (n = ((E.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        o = {},
                        i = 0; i < l; i++)
                            void 0 === o[s = (n = t[i]).selector + " "] && (o[s] = n.needsContext ? -1 < E(s, this).index(c) : E.find(s, this, null, [c]).length),
                            o[s] && r.push(n);
                        r.length && a.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && M(t, "input") && Pe(t, "click", Ee),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && M(t, "input") && Pe(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function He(i, n, s, r) {
        n = g.apply([], n);
        var e, t, o, a, l, c, u = 0, d = i.length, h = d - 1, p = n[0], f = y(p);
        if (f || 1 < d && "string" == typeof p && !b.checkClone && De.test(p))
            return i.each(function(e) {
                var t = i.eq(e);
                f && (n[0] = p.call(this, e, t.html())),
                He(t, n, s, r)
            });
        if (d && (t = (e = xe(n, i[0].ownerDocument, !1, i, r)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || r)) {
            for (a = (o = E.map(ge(e, "script"), ze)).length; u < d; u++)
                l = e,
                u !== h && (l = E.clone(l, !0, !0),
                a && E.merge(o, ge(l, "script"))),
                s.call(i[u], l, u);
            if (a)
                ...
                u = 0; u < a; u++)
                    l = o[u],
                    fe.test(l.type || "") && !K.access(l, "globalEval") && E.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, {
    ...
    function Be(e, t, i) {
        for (var n, s = t ? E.filter(t, e) : e, r = 0; null != (n = s[r]); r++)
            ...
            n.parentNode && (i && re(n) && ve(ge(n, "script")),
    ...
    E.extend({
        ...
        clone: function(e, t, i) {
            var n, s, r, o, a, l, c, u = e.cloneNode(!0), d = re(e);
            if (!(b.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                for (o = ge(u),
                n = 0,
                s = (r = ge(e)).length; n < s; n++)
                    a = r[n],
                    "input" === (c = (l = o[n]).nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (i)
                    for (r = r || ge(e),
                    o = o || ge(u),
                    ...
                    Ne(e, u);
            return 0 < (o = ge(u, "script")).length && ve(o, !d && ge(e, "script")),
            u
        },
    ...
    E.fn.extend({
        ...
        html: function(e) {
            return R(this, function(e) {
                ...
                if ("string" == typeof e && !Ae.test(e) && !me[(pe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (t = this[i] || {}).nodeType && (E.cleanData(ge(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return He(this, arguments, function(e) {
                ...
                E.inArray(this, i) < 0 && (E.cleanData(ge(this)),
    ...
    E.each({
        ...
        E.fn[e] = function(e) {
            for (var t, i = [], n = E(e), s = n.length - 1, r = 0; r <= s; r++)
    ...
    var Fe, je, qe, Re, Ve, We, Ye, Xe = new RegExp("^(" + te + ")(?!px)[a-z%]+$","i"), Ge = function(e) {
    ...
    function Ke(e, t, i) {
        ...
        return (i = i || Ge(e)) && ("" !== (o = i.getPropertyValue(t) || i[t]) || re(e) || (o = E.style(e, t)),
        !b.pixelBoxStyles() && Xe.test(o) && Ue.test(t) && (n = a.width,
        s = a.minWidth,
        r = a.maxWidth,
    ...
    function Qe() {
        if (Ye) {
            ...
            se.appendChild(We).appendChild(Ye);
    ...
    (Ye = S.createElement("div")).style && (Ye.style.backgroundClip = "content-box",
    Ye.cloneNode(!0).style.backgroundClip = "",
    b.clearCloneStyle = "content-box" === Ye.style.backgroundClip,
    E.extend(b, {
    ...
    function ct(e, t, i, n, s, r) {
        ...
        if (i === (n ? "border" : "content"))
            return 0;
        for (; o < 4; o += 2)
            "margin" === i && (l += E.css(e, i + ne[o], !0, s)),
            n ? ("content" === i && (l -= E.css(e, "padding" + ne[o], !0, s)),
            "margin" !== i && (l -= E.css(e, "border" + ne[o] + "Width", !0, s))) : (l += E.css(e, "padding" + ne[o], !0, s),
            "padding" !== i ? l += E.css(e, "border" + ne[o] + "Width", !0, s) : a += E.css(e, "border" + ne[o] + "Width", !0, s));
    ...
    function ut(e, t, i) {
        ...
        return (!b.boxSizingReliable() && s || "auto" === o || !parseFloat(o) && "inline" === E.css(e, "display", !1, n)) && e.getClientRects().length && (s = "border-box" === E.css(e, "boxSizing", !1, n),
        (r = a in e) && (o = e[a])),
    ...
    E.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s, r, o, a = X(t), l = rt.test(t), c = e.style;
                if (l || (t = nt(a)),
                o = E.cssHooks[t] || E.cssHooks[a],
                void 0 === i)
                    return o && "get"in o && void 0 !== (s = o.get(e, !1, n)) ? s : c[t];
                "string" == (r = typeof i) && (s = ie.exec(i)) && s[1] && (i = ce(e, t, s),
                r = "number"),
                null != i && i == i && ("number" !== r || l || (i += s && s[3] || (E.cssNumber[a] ? "" : "px")),
                b.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (c[t] = "inherit"),
        ...
        css: function(e, t, i, n) {
            ...
            (o = E.cssHooks[t] || E.cssHooks[a]) && "get"in o && (s = o.get(e, !0, i)),
            void 0 === s && (s = Ke(e, t, n)),
    ...
    E.each(["height", "width"], function(e, l) {
        E.cssHooks[l] = {
            get: function(e, t, i) {
                if (t)
                    return !st.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ut(e, l, i) : le(e, ot, function() {
                        return ut(e, l, i)
                    })
            },
            set: function(e, t, i) {
                var n, s = Ge(e), r = !b.scrollboxSize() && "absolute" === s.position, o = (r || i) && "border-box" === E.css(e, "boxSizing", !1, s), a = i ? ct(e, l, i, o, s) : 0;
                return o && r && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(s[l]) - ct(e, l, "border", !1, s) - .5)),
                a && (n = ie.exec(t)) && "px" !== (n[3] || "px") && (e.style[l] = t,
                t = E.css(e, l)),
                lt(0, t, a)
            }
        }
    ...
    E.cssHooks.marginLeft = Ze(b.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Ke(e, "marginLeft")) || e.getBoundingClientRect().left - le(e, {
                marginLeft: 0
            }, function() {
    ...
    E.fx.step = {};
    var ht, pt, ft, mt, gt = /^(?:toggle|show|hide)$/, vt = /queueHooks$/;
    function bt() {
        pt && (!1 === S.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(bt) : C.setTimeout(bt, E.fx.interval),
        E.fx.tick())
    }
    function yt() {
    ...
    function Tt(r, e, t) {
        var i, o, n = 0, s = Tt.prefilters.length, a = E.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var e = ht || yt(), t = Math.max(0, c.startTime + c.duration - e), i = 1 - (t / c.duration || 0), n = 0, s = c.tweens.length; n < s; n++)
                c.tweens[n].run(i);
            return a.notifyWith(r, [c, i, t]),
            i < 1 && s ? t : (s || a.notifyWith(r, [c, 1, 0]),
            a.resolveWith(r, [c]),
            !1)
        }, c = a.promise({
            elem: r,
        ...
        for (function(e, t) {
            ...
            if (i = Tt.prefilters[n].call(c, r, u, c.opts))
                return y(i.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                i;
        return E.map(u, xt, c),
    ...
    E.Animation = E.extend(Tt, {
        ...
        tweener: function(e, t) {
            for (var i, n = 0, s = (e = y(e) ? (t = e,
            ["*"]) : e.match(O)).length; n < s; n++)
                i = e[n],
                Tt.tweeners[i] = Tt.tweeners[i] || [],
                Tt.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            var n, s, r, o, a, l, c, u, d = "width"in t || "height"in t, h = this, p = {}, f = e.style, m = e.nodeType && ae(e), g = K.get(e, "fxshow");
            ...
            if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
                ...
                "none" === (u = E.css(e, "display")) && (c ? u = c : (de([e], !0),
                c = e.style.display || c,
                u = E.css(e, "display"),
                de([e]))),
                ("inline" === u || "inline-block" === u && null != c) && "none" === E.css(e, "float") && (l || (h.done(function() {
                    f.display = c
                }),
                null == c && (u = f.display,
                c = "none" === u ? "" : u)),
    ...
    E.fn.extend({
        ...
        stop: function(s, e, r) {
            ...
            this.each(function() {
                ...
                if (t)
                    ...
                    for (t in n)
                        n[t] && n[t].stop && vt.test(t) && o(n[t]);
                for (t = i.length; t--; )
                    i[t].elem !== this || null != s && i[t].queue !== s || (i[t].anim.stop(r),
                    e = !1,
                    i.splice(t, 1));
        ...
        finish: function(o) {
            return !1 !== o && (o = o || "fx"),
            this.each(function() {
                var e, t = K.get(this), i = t[o + "queue"], n = t[o + "queueHooks"], s = E.timers, r = i ? i.length : 0;
                for (t.finish = !0,
                E.queue(this, o, []),
                n && n.stop && n.stop.call(this, !0),
                e = s.length; e--; )
                    s[e].elem === this && s[e].queue === o && (s[e].anim.stop(!0),
                    s.splice(e, 1));
                for (e = 0; e < r; e++)
    ...
    mt = S.createElement("select").appendChild(S.createElement("option")),
    ft.type = "checkbox",
    b.checkOn = "" !== ft.value,
    b.optSelected = mt.selected,
    (ft = S.createElement("input")).value = "t",
    ft.type = "radio",
    b.radioValue = "t" === ft.value;
    ...
    E.extend({
        attr: function(e, t, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? E.prop(e, t, i) : (1 === r && E.isXMLDoc(e) || (s = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? Ct : void 0)),
        ...
        toggleClass: function(s, t) {
            ...
            return "boolean" == typeof t && o ? t ? this.addClass(s) : this.removeClass(s) : y(s) ? this.each(function(e) {
                ...
                if (o)
                    ...
                    void 0 !== s && "boolean" != r || ((e = Mt(this)) && K.set(this, "__className__", e),
                    this.setAttribute && this.setAttribute("class", e || !1 === s ? "" : K.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, i, n = 0;
            for (t = " " + e + " "; i = this[n++]; )
                if (1 === i.nodeType && -1 < (" " + $t(Mt(i)) + " ").indexOf(t))
                    return !0;
            return !1
        }
    });
    ...
    E.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var i, n, s = e.options, r = E.makeArray(t), o = s.length; o--; )
                        ((n = s[o]).selected = -1 < E.inArray(E.valHooks.option.get(n), r)) && (i = !0);
    ...
    E.extend(E.event, {
        trigger: function(e, t, i, n) {
            var s, r, o, a, l, c, u, d, h = [i || S], p = v.call(e, "type") ? e.type : e, f = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = d = o = i = i || S,
            3 !== i.nodeType && 8 !== i.nodeType && !Dt.test(p + E.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(),
            f.sort()),
            l = p.indexOf(":") < 0 && "on" + p,
            (e = e[E.expando] ? e : new E.Event(p,"object" == typeof e && e)).isTrigger = n ? 2 : 3,
            e.namespace = f.join("."),
            ...
            n || !u.trigger || !1 !== u.trigger.apply(i, t))) {
                if (!n && !u.noBubble && !m(i)) {
                    ...
                    Dt.test(a + p) || (r = r.parentNode); r; r = r.parentNode)
                        h.push(r),
                        o = r;
                ...
                for (s = 0; (r = h[s++]) && !e.isPropagationStopped(); )
                    d = r,
                    e.type = 1 < s ? a : u.bindType || p,
                    (c = (K.get(r, "events") || {})[e.type] && K.get(r, "handle")) && c.apply(r, t),
                    (c = l && r[l]) && c.apply && G(r) && (e.result = c.apply(r, t),
                    !1 === e.result && e.preventDefault());
                return e.type = p,
                n || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !G(i) || l && y(i[p]) && !m(i) && ((o = i[l]) && (i[l] = null),
                E.event.triggered = p,
                e.isPropagationStopped() && d.addEventListener(p, At),
                i[p](),
                e.isPropagationStopped() && d.removeEventListener(p, At),
    ...
    b.focusin || E.each({
        ...
        E.event.special[n] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this
                  , t = K.access(e, n) - 1;
                t ? K.access(e, n, t) : (e.removeEventListener(i, s, !0),
                K.remove(e, n))
            }
        }
    });
    ...
    E.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var u, d, h, i, p, n, f, m, s, r, g = E.ajaxSetup({}, t), v = g.context || g, b = g.context && (v.nodeType || v.jquery) ? E(v) : E.event, y = E.Deferred(), w = E.Callbacks("once memory"), x = g.statusCode || {}, o = {}, a = {}, l = "canceled", T = {
                readyState: 0,
            ...
            if (y.promise(T),
            g.url = ((e || g.url || _t.href) + "").replace(Yt, _t.protocol + "//"),
            ...
            null == g.crossDomain) {
                ...
                try {
                    n.href = g.url,
                    n.href = n.href,
                    g.crossDomain = Kt.protocol + "//" + Kt.host != n.protocol + "//" + n.host
                } catch (e) {
                    g.crossDomain = !0
                }
            }
            ...
            f)
                return T;
            for (s in (m = E.event && g.global) && 0 == E.active++ && E.event.trigger("ajaxStart"),
            g.type = g.type.toUpperCase(),
            g.hasContent = !Wt.test(g.type),
            d = g.url.replace(qt, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(jt, "+")) : (r = g.url.slice(d.length),
            g.data && (g.processData || "string" == typeof g.data) && (d += (zt.test(d) ? "&" : "?") + g.data,
            delete g.data),
            ...
            T.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Ut + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
                T.setRequestHeader(s, g.headers[s]);
            ...
            function c(e, t, i, n) {
                ...
                s ? (g.ifModified && ((l = T.getResponseHeader("Last-Modified")) && (E.lastModified[d] = l),
                ...
                T.status = e,
                T.statusText = (t || c) + "",
                s ? y.resolveWith(v, [r, c, T]) : y.rejectWith(v, [T, c, o]),
                T.statusCode(x),
                x = void 0,
                m && b.trigger(s ? "ajaxSuccess" : "ajaxError", [T, g, s ? r : o]),
                w.fireWith(v, [T, c]),
                m && (b.trigger("ajaxComplete", [T, g]),
    ...
    b.cors = !!ti && "withCredentials"in ti,
    b.ajax = ti = !!ti,
    E.ajaxTransport(function(s) {
        var r, o;
        if (b.cors || ti && !s.crossDomain)
            return {
                send: function(e, t) {
                    var i, n = s.xhr();
                    ...
                    r = function(e) {
                        return function() {
                            r && (r = o = n.onload = n.onerror = n.onabort = n.ontimeout = n.onreadystatechange = null,
                            "abort" === e ? n.abort() : "error" === e ? "number" != typeof n.status ? t(0, "error") : t(n.status, n.statusText) : t(ei[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    E.ajaxPrefilter("json jsonp", function(e, t, i) {
        ...
        if (o || "jsonp" === e.dataTypes[0])
            ...
            o ? e[o] = e[o].replace(si, "$1" + n) : !1 !== e.jsonp && (e.url += (zt.test(e.url) ? "&" : "?") + e.jsonp + "=" + n),
            ...
            ,
            i.always(function() {
                void 0 === s ? E(C).removeProp(n) : C[n] = s,
    ...
    b.createHTMLDocument = ((ii = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ii.childNodes.length),
    E.parseHTML = function(e, t, i) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t,
        t = !1),
        t || (b.createHTMLDocument ? ((n = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href,
        t.head.appendChild(n)) : t = S),
        r = !i && [],
        (s = P.exec(e)) ? [t.createElement(s[1])] : (s = xe([e], t, r),
    ...
    E.offset = {
        setOffset: function(e, t, i) {
            var n, s, r, o, a, l, c = E.css(e, "position"), u = E(e), d = {};
            "static" === c && (e.style.position = "relative"),
            a = u.offset(),
            r = E.css(e, "top"),
            l = E.css(e, "left"),
            s = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (o = (n = u.position()).top,
    ...
    E.each({
        ...
        E.each({
            ...
            E.fn[r] = function(e, t) {
                ...
                return R(this, function(e, t, i) {
                    var n;
                    return m(e) ? 0 === r.indexOf("outer") ? e["inner" + o] : e.document.documentElement["client" + o] : 9 === e.nodeType ? (n = e.documentElement,
                    Math.max(e.body["scroll" + o], n["scroll" + o], e.body["offset" + o], n["offset" + o], n["client" + o])) : void 0 === i ? E.css(e, t, s) : E.style(e, t, i, s)
                }, a, i ? e : void 0, i)
            }
        })
    }),
...
function(e, t) {
    ...
    var n = {}
      , s = /([a-z\d])([A-Z])/g;
    function h(e) {
        return e in n || (n[e] = e.replace(s, "$1-$2").toLowerCase()),
        n[e]
    }
    var r = /-(\w)/g;
    function p(e) {
    ...
    var ie = {
        ratio: function(e, t, i) {
            ...
            return (n = {})[s] = e[t] ? Math.round(i * e[s] / e[t]) : e[s],
            n[t] = i,
            n
        },
    ...
    function ne(e, t, i) {
        if (E(t))
            ...
            if (H(i))
                return (e = q(e)) && e.getAttribute(t);
            R(e).forEach(function(e) {
                S(i) && (i = i.call(e, ne(e, t))),
                null === i ? re(e, t) : e.setAttribute(t, i)
            })
        }
    }
    function se(e, t) {
    ...
    function he(e, o, t) {
        ...
        e = function(e) {
            ...
            if ("!" === e[0]) {
                ...
                i = xe(o.parentNode, n[0]),
                e = n.slice(1).join(" ").trim()
            }
            if ("-" === e[0]) {
                var s = e.substr(1).trim().split(" ")
                  , r = (i || o).previousElementSibling;
                i = ye(r, e.substr(1)) ? r : null,
                e = s.slice(1).join(" ")
            }
            return i ? (i.id || (i.id = "uk-" + Date.now() + t,
            a.push(function() {
                return re(i, "id")
            })),
            "#" + Se(i.id) + " " + e) : null
    ...
    ;
    function xe(e, t) {
        return b(t, ">") && (t = t.slice(1)),
        I(e) ? we.call(e, t) : R(e).map(function(e) {
            return xe(e, t)
        }).filter(Boolean)
    }
    function Te(e, t) {
        var i = [];
        for (e = q(e); e = e.parentElement; )
            ye(e, t) && i.push(e);
        return i
    }
    ...
    function Oe(e, t, i, n) {
        ...
        L(e)) {
            ...
            s.initCustomEvent(e, t, i, n),
            e = s
        }
        return e
    }
    function Ne(e) {
        return S(e[2]) && e.splice(2, 0, !1),
        e
    }
    function He(e) {
    ...
    function Ue(o, a) {
        return new Ve(function(e, t) {
            ...
            for (var r in n.open(i.method.toUpperCase(), o),
            i.headers)
    ...
    function lt(e) {
        if ("loading" === document.readyState)
            var t = De(document, "DOMContentLoaded", function() {
                t(),
                e()
            });
        else
    ...
    function ut(e, t, i, n) {
        ...
        void 0 === n && (n = !1);
        var s = (t = R(t)).length;
        return e = O(e) ? F(e) : "next" === e ? i + 1 : "previous" === e ? i - 1 : ct(t, e),
        n ? Q(e, 0, s - 1) : (e %= s) < 0 ? e + s : e
    }
    function dt(e) {
        return (e = Et(e)).innerHTML = "",
        e
    }
    function ht(e, t) {
        return e = Et(e),
        H(t) ? e.innerHTML : pt(e.hasChildNodes() ? dt(e) : e, t)
    }
    function pt(t, e) {
        return t = Et(t),
        gt(e, function(e) {
    ...
    function Ct(e) {
        ...
        return xt.test(e) ? i.insertAdjacentHTML("beforeend", e.trim()) : i.textContent = e,
        1 < i.childNodes.length ? R(i.childNodes) : i.firstChild
    }
    function St(e, t) {
        if (e && 1 === e.nodeType)
            for (t(e),
    ...
    function _t(e) {
        for (var n = [], t = arguments.length - 1; 0 < t--; )
            n[t] = arguments[t + 1];
        if (n.length) {
            var s = L((n = zt(n))[n.length - 1]) ? [] : n.pop();
            n = n.filter(Boolean),
            R(e).forEach(function(e) {
                for (var t = e.classList, i = 0; i < n.length; i++)
                    Ot.Force ? t.toggle.apply(t, [n[i]].concat(s)) : t[(H(s) ? !t.contains(n[i]) : s) ? "add" : "remove"](n[i])
            })
        }
    }
    function Lt(e, i, n) {
    ...
    function qt(e) {
        ...
        if (!Ze)
            return Bt(t).getPropertyValue("--uk-" + e);
        if (!(e in jt)) {
            var i = pt(t, document.createElement("div"));
            Mt(i, "uk-" + e),
            jt[e] = Ft(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
            vt(i)
        }
        return jt[e]
    }
        ...
        Ve.all(R(e).map(function(o) {
            return new Ve(function(n, s) {
                if (Dt(o, Ut))
                    ...
                    b(t, Gt) && (a && (e += " uk-transform-origin-" + a),
                    l && (e += " " + Gt + "reverse")),
                    r(),
                    Le(o, "animationend animationcancel", function(e) {
                        var t = e.type
                          , i = !1;
                        "animationcancel" === t ? (s(),
                        r()) : (n(),
                        Ve.resolve().then(function() {
                            i = !0,
                            r()
                        })),
                        requestAnimationFrame(function() {
                    ...
                    Ht(o, "animationDuration", i + "ms"),
                    Mt(o, e)
                }
                function r() {
                    Ht(o, "animationDuration", ""),
                    It(o, Gt + "\\S*")
                }
            }
            )
    ...
    function ii(e) {
        var t, i, n = bi(e = q(e)), s = n.pageYOffset, r = n.pageXOffset;
        if ($(e)) {
            var o = e.innerHeight
              , a = e.innerWidth;
            return {
        ...
        $e(e) || "none" !== Ht(e, "display") || (t = ne(e, "style"),
        i = ne(e, "hidden"),
        ne(e, {
    ...
    function ni(n) {
        var s = (n = q(n)).offsetParent || function(e) {
          ...
          , e = ["top", "left"].reduce(function(e, t) {
            var i = f(t);
            return e[t] -= r[t] + j(Ht(n, "margin" + i)) + j(Ht(s, "border" + i + "Width")),
            e
        }, ti(n));
        return {
            top: e.top,
    ...
    function ai(e, i, t) {
        return void 0 === t && (t = "border-box"),
        Ht(i, "boxSizing") === t ? Jt[e].slice(1).map(f).reduce(function(e, t) {
    ...
    function gi(e, t, i) {
        return void 0 === t && (t = "width"),
        void 0 === i && (i = window),
        O(e) ? +e : u(e, "vh") ? vi(si(bi(i)), e) : u(e, "vw") ? vi(ri(bi(i)), e) : u(e, "%") ? vi(ii(i)[t], e) : j(e)
    }
    function vi(e, t) {
        return e * j(t) / 100
    }
    ...
    var wi = {
        ...
        writes: [],
        read: function(e) {
            return this.reads.push(e),
            Ti(),
            e
        },
        write: function(e) {
            return this.writes.push(e),
            Ti(),
            e
        },
        clear: function(e) {
    ...
    function xi() {
        Ci(wi.reads),
        Ci(wi.writes.splice(0, wi.writes.length)),
        wi.scheduled = !1,
        (wi.reads.length || wi.writes.length) && Ti(!0)
    }
    function Ti(e) {
        void 0 === e && (e = !1),
        wi.scheduled || (wi.scheduled = !0,
        e ? Ve.resolve().then(xi) : requestAnimationFrame(xi))
    }
    function Ci(e) {
        for (var t; t = e.shift(); )
            t()
    ...
    Ei.prototype = {
        ...
        init: function() {
            ...
            this.unbind = De(document, "mousemove", function(i) {
                s || (setTimeout(function() {
                    ...
                    t && 100 < e - n.positions[t - 1].time && n.positions.splice(0, t),
                    n.positions.push({
                        time: e,
                        x: i.pageX,
                        y: i.pageY
        ...
        movesTo: function(e) {
            ...
            var t = ti(e)
              ...
              , n = this.positions[0];
            if (t.left <= i.x && i.x <= t.right && t.top <= i.y && i.y <= t.bottom)
                return !1;
            var s = [[{
                x: t.left,
                y: t.top
            ...
            return t.right <= i.x || (t.left >= i.x ? (s[0].reverse(),
            s[1].reverse()) : t.bottom <= i.y ? s[0].reverse() : t.top >= i.y && s[1].reverse()),
    ...
    function Pi(e, t) {
        return e = e && !C(e) ? [e] : e,
        t ? e ? e.concat(t) : C(t) ? t : [t] : e
    }
    function Ii(t, i, n) {
        var s = {};
        if (S(i) && (i = i.options),
        i.extends && (t = Ii(t, i.extends, n)),
        i.mixins)
            for (var e = 0, r = i.mixins.length; e < r; e++)
                t = Ii(t, i.mixins[e], n);
        for (var o in t)
            l(o);
        for (var a in i)
    ...
    function Ai(e, t) {
        ...
        void 0 === t && (t = []);
        try {
            return e ? b(e, "{") ? JSON.parse(e) : t.length && !w(e, ":") ? ((i = {})[t[0]] = e,
            i) : e.split(";").reduce(function(e, t) {
                var i = t.split(/:(.*)/)
                  , n = i[0]
                  , s = i[1];
                return n && !H(s) && (e[n.trim()] = s.trim()),
                e
            }, {}) : {}
        } catch (e) {
            return {}
    ...
    $i.events = $i.created = $i.beforeConnect = $i.connected = $i.beforeDisconnect = $i.disconnected = $i.destroy = Pi,
    $i.args = function(e, t) {
        return !1 !== t && Pi(t || e)
    }
    ,
    ...
    Di.prototype.enableApi = function() {
        ...
        if (this.ready)
            return this.ready;
        var i, n = this.isYoutube(), s = this.isVimeo();
    ...
    var zi = "IntersectionObserver"in window ? window.IntersectionObserver : function() {
        function e(t, e) {
            ...
            void 0 === n && (n = "0 0"),
            this.targets = [];
            var s, r = (n || "0 0").split(" ").map(j), o = r[0], a = r[1];
            this.offsetTop = o,
            this.offsetLeft = a,
            this.apply = function() {
    ...
    function Xi(e, t) {
        if (e)
            for (var i in e)
                e[i]._connected && e[i]._callUpdate(t)
    }
    function Gi(e, t) {
        var i = {}
          , n = e.args;
        ...
        Object.defineProperty(n, s, {
            ...
            get: function() {
                var e = n._computeds
                  , t = n.$props
                  , i = n.$el;
                return c(e, s) || (e[s] = (r.get || r).call(n, t, i)),
                e[s]
            },
            set: function(e) {
                var t = n._computeds;
                t[s] = r.set ? r.set.call(n, e) : e,
                H(t[s]) && delete t[s]
            }
        })
    }
    function Ki(t, i, n) {
        ...
        var e = i.name
          ...
          , c = i.filter
          , u = i.self;
        s = S(s) ? s.call(t) : s || t.$el,
        C(s) ? s.forEach(function(e) {
            return Ki(t, G({}, i, {
                el: e
            }), n)
        ...
        t._events.push(De(s, e, l ? L(l) ? l : l.call(t) : null, r, _(a) ? {
            passive: a,
            capture: o
        } : o)))
    }
    ...
    Hi.extend = function(e) {
        ...
        return e = e || {},
        ((t.prototype = Object.create(this.prototype)).constructor = t).options = Ii(this.options, e),
        t.super = this,
    ...
    Hi.update = function(e, t) {
        (function e(t, i) {
            t && t !== document.body && t.parentNode && (e(t.parentNode, i),
            i(t.parentNode))
        }
    ...
    ,
    Ri = 0,
    (qi = Ni).prototype._init = function(e) {
        (e = e || {}).data = function(e, t) {
            ...
            t.args)
              , s = t.props;
            if (void 0 === s && (s = {}),
            i = C(i) ? N(n) ? void 0 : i.slice(0, n.length).reduce(function(e, t, i) {
                return k(t) ? G(e, t) : e[n[i]] = t,
                e
            }, {}) : i)
                for (var r in i)
                    H(i[r]) ? delete i[r] : i[r] = s[r] ? Qi(s[r], i[r]) : i[r];
            return i
        }(e, this.constructor.options),
        this.$options = Ii(this.constructor.options, e, this),
        this.$el = null,
        this.$props = {},
        this._frames = {
            reads: {},
    ...
    qi.prototype._callWatches = function() {
        ...
        for (var i in t) {
            var n = t[i];
            delete t[i],
            e[i].watch && !Y(n, this[i]) && e[i].watch.call(this, this[i], n)
        }
    }
    ,
    qi.prototype._initProps = function(e) {
        var t;
        for (t in e = e || Gi(this.$options, this.$name))
            H(e[t]) || (this.$props[t] = e[t]);
        var i = [this.$options.computed, this.$options.methods];
        for (t in this.$props)
            t in e && Zi(i, t) && (this[t] = this.$props[t])
    }
    ,
    ...
    Wi = (Vi = Ni).data,
    Yi = {},
    Vi.component = function(o, e) {
        if (!e)
            return k(Yi[o]) && (Yi[o] = Vi.extend(Yi[o])),
            Yi[o];
        Vi[o] = function(e, i) {
        ...
        if (t.name = o,
        t.install && t.install(Vi, t, o),
        Vi._initialized && !t.functional) {
            var i = h(o);
            wi.read(function() {
    ...
    function(n) {
        ...
        n.prototype.$mount = function(e) {
            ...
            e[s] || (e[s] = {}),
            e[s][t] || ((e[s][t] = this).$el = this.$options.el = this.$options.el || e,
            Ae(e, document) && this._callConnected())
        }
        ,
      ...
      , en = {
        ...
        methods: {
            ...
            _toggleElement: function(e, t, i) {
                var n = this;
                if (t = _(t) ? t : Qt.inProgress(e) ? Dt(e, "uk-animation-leave") : Xt.inProgress(e) ? "0px" === e.style.height : !this.isToggled(e),
                !ze(e, "before" + (t ? "show" : "hide"), [this]))
                    return Ve.reject();
                var s = (S(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? function(e) {
                    ...
                    return function(e, t) {
                        return Qt.cancel(e),
                        t ? (r(e, !0),
                        Qt.in(e, i[0], n, s)) : Qt.out(e, i[1] || i[0], n, s).then(function() {
                            return r(e, !1)
                        })
                    }
            ...
            _toggle: function(e, t) {
                var i;
                e && (t = Boolean(t),
                this.cls ? (i = w(this.cls, " ") || t !== Dt(e, this.cls)) && _t(e, this.cls, w(this.cls, " ") ? void 0 : t) : (i = t === se(e, "hidden")) && ne(e, "hidden", t ? null : ""),
                kt("[autofocus]", e).some(function(e) {
    ...
    var tn = {
        ...
        events: [{
            ...
            handler: function(e) {
                e.preventDefault(),
                this.toggle(ct(kt(this.targets + " " + this.$props.toggle, this.$el), e.current))
            }
        }],
        connected: function() {
            if (!1 !== this.active) {
            ...
            toggle: function(s, r) {
                ...
                (s = this.items[e]) && [s].concat(!this.multiple && !w(a, s) && a || []).forEach(function(e) {
                    ...
                    if (i || !t || o.collapsible || !(a.length < 2)) {
                        ...
                        e._wrapper || (e._wrapper = bt(n, "<div>"),
                        ne(e._wrapper, "hidden", i ? "" : null)),
                        o._toggle(n, !0),
                        o.toggleElement(e._wrapper, i, r).then(function() {
                            Dt(e, o.clsOpen) === i && (i || o._toggle(n, !1),
                            e._wrapper = null,
                            wt(n))
                        })
                    }
    ...
    function sn(s) {
        lt(function() {
            var i;
            s.update(),
            De(window, "load resize", function() {
            ...
            De(document, "animationstart", function(e) {
                var t = e.target;
                (Ht(t, "animationName") || "").match(/^uk-.*(left|right)/) && (n++,
                Ht(document.body, "overflowX", "hidden"),
                setTimeout(function() {
                    --n || Ht(document.body, "overflowX", "")
                }, W(Ht(t, "animationDuration")) + 100))
            }, !0),
            De(document, it, function(e) {
                if (t && t(),
                je(e)) {
                    var s = qe(e)
    ...
    var rn, on, an = {
        ...
        connected: function() {
            this.inView && !se(this.$el, "preload") && (this.$el.preload = "none"),
            this.player = new Di(this.$el),
        ...
        methods: {
            positionAt: function(e, t, i) {
                var n;
                It(e, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?"),
                Ht(e, {
                    top: "",
                    left: ""
                });
                ...
                this.dir = "x" === r ? a : l,
                this.align = "x" === r ? l : a,
                _t(e, this.clsPos + "-" + this.dir + "-" + this.align, !1 === this.offset)
            },
            getAxis: function() {
        ...
        events: [{
            ...
            name: "toggleshow",
            handler: function(e, t) {
                t && !w(t.target, this.$el) || (e.preventDefault(),
                this.show(t || this.toggle))
            }
        }, {
            name: "togglehide " + ot,
            handler: function(e, t) {
                je(e) || t && !w(t.target, this.$el) || (e.preventDefault(),
                this.toggle && w(this.toggle.mode, "hover") && this.hide())
            }
        }, {
            name: "beforeshow",
            self: !0,
            ...
            handler: function() {
                this.tracker.init(),
                ze(this.$el, "updatearia"),
                function() {
                    if (on)
                        return;
                    on = !0,
                    De(document, st, function(e) {
                        var t, i = e.target;
                        if (!e.defaultPrevented)
                            for (; rn && rn !== t && !Ae(i, rn.$el) && (!rn.toggle || !Ae(i, rn.toggle.$el)); )
                                (t = rn).hide(!1)
                    })
                }()
            }
            ...
            handler: function(e) {
                var t = e.target;
                this.$el === t ? (rn = this.isActive() ? null : rn,
                ze(this.$el, "updatearia"),
                this.tracker.cancel()) : rn = null === rn && Ae(t, this.$el) && this.isToggled() ? this : rn
            }
        }, {
            name: "updatearia",
            self: !0,
            handler: function(e, t) {
                ...
                (t || this.toggle) && (ne((t || this.toggle).$el, "aria-expanded", this.isToggled() ? "true" : "false"),
                _t(this.toggle.$el, this.cls, this.isToggled()))
            }
        }],
        update: {
            write: function() {
        ...
        methods: {
                        ...
                        if (i && rn && rn !== n && rn.isDelaying)
                            ...
                            if (n.isParentOf(rn)) {
                                if (!rn.hideTimer)
                                    return;
                                rn.hide(!1)
                            } else if (rn && n.isChildOf(rn))
                                rn.clearTimers();
                            else if (rn && !n.isChildOf(rn) && !n.isParentOf(rn))
                                for (var e; rn && rn !== e && !n.isChildOf(rn); )
                                    (e = rn).hide(!1);
                            i && n.delayShow ? n.showTimer = setTimeout(s, n.delayShow) : s(),
                            rn = n
                        }
                }
                t && this.toggle && t.$el !== this.toggle.$el ? (Le(this.$el, "hide", e),
                this.hide(!1)) : e()
            },
            hide: function(e) {
                var t = this;
                ...
                e && this.isDelaying ? this.hideTimer = setTimeout(this.hide, this.hoverIdle) : e && this.delayHide ? this.hideTimer = setTimeout(i, this.delayHide) : i()
            },
            ...
            position: function() {
                It(this.$el, this.clsDrop + "-(stack|boundary)"),
                Ht(this.$el, {
                    top: "",
                    left: "",
                    display: "block"
                ...
                if ("justify" === this.align) {
                    ...
                    this.$el.offsetWidth > Math.max(e.right - t.left, t.right - e.left) && Mt(this.$el, this.clsDrop + "-stack");
      ...
      , hn = {
        ...
        update: function() {
            var e = this.target
              , t = this.input;
            if (e) {
                var i, n = Pe(e) ? "value" : "textContent", s = e[n], r = t.files && t.files[0] ? t.files[0].name : ye(t, "select") && (i = kt("option", t).filter(function(e) {
                    return e.selected
        ...
        for (var t = [[]], i = 0; i < e.length; i++) {
            ...
            if (s.height)
                for (var r = t.length - 1; 0 <= r; r--) {
                    ...
                    var a = void 0;
                    if (a = o[0].offsetParent === n.offsetParent ? gn(o[0]) : (s = gn(n, !0),
                    gn(o[0], !0)),
                    s.top >= a.bottom - 1 && s.top !== a.top) {
                        t.push([n]);
                        break
                    }
                    if (s.bottom > a.top) {
    ...
    var vn = {
        ...
        update: [{
            ...
            write: function(e) {
                var t = e.stacks
                  , i = e.height;
                _t(this.$el, this.clsStack, t),
                Ht(this.$el, "paddingBottom", this.parallax),
                !1 !== i && Ht(this.$el, "height", i)
            },
            events: ["resize"]
        }, {
            read: function(e) {
        ...
        update: {
            read: function(e) {
                ...
                if (this.expand) {
                    ...
                    !0 === this.offsetBottom ? i += " - " + Cn(this.$el.nextElementSibling) + "px" : O(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : L(this.offsetBottom) && (i += " - " + Cn(ae(this.offsetBottom, this.$el)) + "px"),
                    i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
            ...
            write: function(e) {
                ...
                t !== i && this.$update(this.$el, "resize"),
                this.minHeight && j(Ht(this.$el, "minHeight")) < this.minHeight && Ht(this.$el, "minHeight", this.minHeight)
            },
            events: ["resize"]
        }
    };
    ...
    var Sn = {
        ...
        disconnected: function() {
            var t = this;
            ke(this.$el) && ne(this.$el, "hidden", null),
        ...
        methods: {
                    ...
                    return function(e, t) {
                        t && w(e, "<symbol") && (e = function(e, t) {
                            if (!$n[e]) {
                                var i;
                                for ($n[e] = {}; i = kn.exec(e); )
                                    $n[e][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                                kn.lastIndex = 0
                            }
                            return $n[e][t]
                        }(e, t) || e);
            ...
            applyAttributes: function(i) {
                var n = this;
                for (var e in this.$options.props)
                    this[e] && w(this.include, e) && ne(i, e, this[e]);
    ...
    var Hn = {
        ...
        connected: function() {
            ...
            this.observer = new zi(this.load,{
        ...
        update: {
            ...
            write: function(e) {
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    Ht(this.$el, "backgroundSize", e.bgSize + "px"))
                }
            },
            events: ["resize"]
        },
        methods: {
            load: function(e) {
                ...
                e.some(function(e) {
                    ...
                    return Bn(t.$el, Yn(e), e.srcset, e.sizes),
                    Xn[t.cacheKey] = Yn(e),
                    e
                }, J),
                this.observer.disconnect())
    ...
    function Bn(e, t, i, n) {
        if (Wn(e))
            ...
            !w(e.style.backgroundImage, t) && (Ht(e, "backgroundImage", "url(" + Se(t) + ")"),
            ze(e, Oe("load", !1)))
        }
    }
    ...
    var Kn, Zn, Qn = {
        ...
        update: {
            ...
            write: function(e) {
                _t(this.wrapper, this.clsHide, e.hide),
                e.changed && (e.changed = !1,
                ne(this.wrapper, this.attrFill, new Array(e.width).join(e.fill)))
            },
            events: ["resize"]
        }
    }, Jn = {
        ...
        events: [{
            ...
            handler: function(e) {
                var t = Kn && Kn !== this && Kn;
                Kn = this,
                t ? this.stack ? this.prev = t : ((Kn = t).hide().then(this.show),
                e.preventDefault()) : function() {
                    ...
                    Zn = [De(document, st, function(e) {
                        ...
                        27 === e.keyCode && Kn && Kn.escClose && (e.preventDefault(),
                        Kn.hide())
                    })]
                }()
            }
            ...
            self: !0,
            handler: function() {
                Dt(document.documentElement, this.clsPage) || (this.scrollbarWidth = ri(window) - ri(document),
                Ht(document.body, "overflowY", this.scrollbarWidth && this.overlay ? "scroll" : "")),
                Mt(document.documentElement, this.clsPage)
            }
        }, {
            name: "hide",
            self: !0,
        ...
        methods: {
            ...
            show: function() {
                var t = this;
                return this.container && this.$el.parentNode !== this.container ? (pt(this.container, this.$el),
                new Ve(function(e) {
    ...
    var is = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Dt(this.panel, "uk-margin-auto-vertical") ? Mt(this.$el, "uk-flex") : Ht(this.$el, "display", "block"),
                si(this.$el)
            }
        }, {
            name: "hidden",
    ...
    var ns = {
      ...
      , ss = {
        ...
        beforeConnect: function() {
            ...
            this.dropbar = e && (ae(e, this.$el) || Et("+ .uk-navbar-dropbar", this.$el) || Et("<div></div>")),
            this.dropbar && (Mt(this.dropbar, "uk-navbar-dropbar"),
            "slide" === this.dropbarMode && Mt(this.dropbar, "uk-navbar-dropbar-slide"))
        },
        disconnected: function() {
        ...
        events: [{
            ...
            handler: function(e, t) {
                var i = t.$el
                  , n = t.dir;
                this.clsDrop && Mt(i, this.clsDrop + "-dropbar"),
                "bottom" === n && this.transitionTo(i.offsetHeight + j(Ht(i, "marginTop")) + j(Ht(i, "marginBottom")), i)
            }
        }, {
            name: "beforehide",
            filter: function() {
        ...
        methods: {
            ...
            transitionTo: function(e, t) {
                var i = this
                  , n = this.dropbar
                  , s = $e(n) ? si(n) : 0;
                return Ht(t = s < e && t, "clip", "rect(0," + t.offsetWidth + "px," + s + "px,0)"),
                si(n, s),
                Xt.cancel([t, n]),
                Ve.all([Xt.start(n, {
                    height: e
      ...
      , rs = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                "reveal" !== this.mode || Dt(this.panel.parentNode, this.clsMode) || (bt(this.panel, "<div>"),
                Mt(this.panel.parentNode, this.clsMode)),
                Ht(document.documentElement, "overflowY", this.overlay ? "hidden" : ""),
                Mt(document.body, this.clsContainer, this.clsFlip),
                Ht(document.body, "touch-action", "pan-y pinch-zoom"),
                Ht(this.$el, "display", "block"),
                Mt(this.$el, this.clsOverlay),
                Mt(this.panel, this.clsSidebarAnimation, "reveal" !== this.mode ? this.clsMode : ""),
                si(document.body),
                Mt(document.body, this.clsContainerAnimation),
                this.clsContainerAnimation && (os().content += ",user-scalable=0")
            }
        }, {
            name: "hide",
            self: !0,
            handler: function() {
                Pt(document.body, this.clsContainerAnimation),
                Ht(document.body, "touch-action", "");
                var e = this.getActive();
            ...
            handler: function() {
                ...
                "reveal" === this.mode && wt(this.panel),
                Pt(this.panel, this.clsSidebarAnimation, this.clsMode),
                Pt(this.$el, this.clsOverlay),
                Ht(this.$el, "display", ""),
                Pt(document.body, this.clsContainer, this.clsFlip),
                Ht(document.documentElement, "overflowY", "")
            }
        }, {
    ...
    var as = {
        ...
        update: {
            ...
            write: function(e) {
                var t = e.current
                  , i = e.max;
                Ht(this.$el, "maxHeight", i),
                Math.round(t) !== Math.round(i) && ze(this.$el, "resize")
            },
            events: ["resize"]
        }
    }
      ...
      , cs = {
        ...
        methods: {
            scrollTo: function(t) {
                ...
                if (e < s + n && (s = e - n),
                ze(this.$el, "beforescroll", [this, t])) {
                    var r = Date.now()
                      ...
                      , a = function() {
                        ...
                        e !== s ? requestAnimationFrame(a) : ze(i.$el, "scrolled", [i, t])
                    };
                    a()
                }
            }
        ...
        events: {
            click: function(e) {
                e.defaultPrevented || (e.preventDefault(),
                this.scrollTo(Se(decodeURIComponent(this.$el.hash)).substr(1)))
            }
        }
    };
    var us = {
        ...
        update: [{
            ...
            read: function(e) {
                ...
                e.update && this.elements.forEach(function(e) {
                    ...
                    }).show = hi(e, i.offsetTop, i.offsetLeft),
                    e._ukScrollspyState = t
                })
            },
            write: function(s) {
                var r = this;
                ...
                this.elements.forEach(function(e) {
                    ...
                    if (!i.show || i.inview || i.queued) {
                        if (!i.show && (i.inview || i.queued) && r.repeat) {
                            ...
                            !i.inview)
                                return;
                            Ht(e, "visibility", r.hidden ? "hidden" : ""),
                            Pt(e, r.inViewClass),
                            _t(e, t),
                            ze(e, "outview"),
                            r.$update(e),
                        ...
                        r.delay ? (i.queued = !0,
                        s.promise = (s.promise || Ve.resolve()).then(function() {
      ...
      , ds = {
        ...
        update: [{
            ...
            read: function(r) {
                ...
                r.active = !1,
                this.targets.every(function(e, t) {
                    var i = ti(e).top
                      , n = t + 1 === o.targets.length;
                    if (!o.overflow && (0 === t && a < i || n && i + e.offsetTop < a))
                        return !1;
                    if (!n && ti(o.targets[t + 1]).top <= a)
                        return !0;
                    if (l <= a)
            ...
            write: function(e) {
                ...
                t && ze(this.$el, "active", [t, Mt(this.closest ? xe(t, this.closest) : t, this.cls)])
            },
            events: ["scroll", "resize"]
        }]
    }
      , hs = {
        ...
        computed: {
            ...
            isActive: {
                ...
                set: function(e) {
                    e && !this.isActive ? (At(this.selTarget, this.clsInactive, this.clsActive),
                    ze(this.$el, "active")) : e || Dt(this.selTarget, this.clsInactive) || (At(this.selTarget, this.clsActive, this.clsInactive),
                    ze(this.$el, "inactive"))
                }
            }
        },
        connected: function() {
            this.placeholder = Et("+ .uk-sticky-placeholder", this.$el) || Et('<div class="uk-sticky-placeholder"></div>'),
            this.isFixed = !1,
            this.isActive = !1
        },
        disconnected: function() {
            this.isFixed && (this.hide(),
            Pt(this.selTarget, this.clsInactive)),
            vt(this.placeholder),
        ...
        update: [{
            read: function(e, t) {
                var i = e.height;
                this.isActive && "update" !== t && (this.hide(),
                i = this.$el.offsetHeight,
                this.show()),
                i = this.isActive ? i : this.$el.offsetHeight,
                this.topOffset = ti(this.isFixed ? this.placeholder : this.$el).top,
                this.bottomOffset = this.topOffset + i;
                var n = ps("bottom", this);
                return this.top = Math.max(j(ps("top", this)), this.topOffset) - this.offset,
                this.bottom = n && n - i,
            ...
            read: function(e) {
                var t = e.scroll;
                return void 0 === t && (t = 0),
                this.width = ($e(this.widthElement) ? this.widthElement : this.$el).offsetWidth,
            ...
            write: function(e, t) {
                ...
                var s = e.dir
                  ...
                  , c = e.visible
                  , u = performance.now();
                if (!((e.lastScroll = a) < 0 || a === o || !c || this.disabled || this.showOnUp && "scroll" !== t || ((300 < u - n || s !== r) && (e.initScroll = a,
                e.initTimestamp = u),
                e.lastDir = s,
                this.showOnUp && Math.abs(e.initScroll - a) <= 30 && Math.abs(o - a) <= 10)))
                    if (this.inactive || a < this.top || this.showOnUp && (a <= this.top || "down" === s || "up" === s && !this.isFixed && a <= this.bottomOffset)) {
                        if (!this.isFixed)
                            return void (Qt.inProgress(this.$el) && a < l && (Qt.cancel(this.$el),
                            this.hide()));
                        this.isFixed = !1,
                        this.animation && a > this.topOffset ? (Qt.cancel(this.$el),
                        Qt.out(this.$el, this.animation).then(function() {
                            return i.hide()
                        }, J)) : this.hide()
                    } else
                        this.isFixed ? this.update() : this.animation ? (Qt.cancel(this.$el),
                        this.show(),
                        Qt.in(this.$el, this.animation).catch(J)) : this.show()
            },
            events: ["resize", "scroll"]
        }],
        methods: {
            show: function() {
                this.isFixed = !0,
                this.update(),
                ne(this.placeholder, "hidden", null)
            },
            hide: function() {
                this.isActive = !1,
            ...
            update: function() {
                ...
                this.isActive = e,
                _t(this.$el, this.clsBelow, this.scroll > this.bottomOffset),
                Mt(this.$el, this.clsFixed)
            }
        }
    };
    function ps(e, t) {
    ...
    var fs, ms = {
        ...
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(),
                this.show(R(this.$el.children).filter(function(e) {
        ...
        update: function() {
            ...
            this.show(Ie(e, "." + this.cls)[0] || e[this.active] || e[0]),
            this.swiping && Ht(this.connects, "touch-action", "pan-y pinch-zoom")
        },
        methods: {
            index: function() {
            ...
            show: function(e) {
                for (var t, i, n = this, s = this.$el.children, r = s.length, o = this.index(), a = 0 <= o, l = "previous" === e ? -1 : 1, c = ut(e, s, o), u = 0; u < r; u++,
                c = (c + l + r) % r)
                ...
                !i || 0 <= o && Dt(i, this.cls) || o === c || (Pt(s, this.cls),
                Mt(i, this.cls),
                ne(this.toggles, "aria-expanded", !1),
                ne(t, "aria-expanded", !0),
                this.connects.forEach(function(e) {
        ...
        events: [{
            ...
            handler: function(e) {
                var t;
                (xe(e.target, 'a[href="#"], a[href=""]') || (t = xe(e.target, "a[href]")) && (this.cls || !$e(this.target) || t.hash && ye(this.target, t.hash))) && e.preventDefault(),
                this.toggle()
            }
        }],
        update: {
    ...
    Ni.version = "3.1.7",
    (fs = Ni).component("accordion", tn),
    fs.component("alert", nn),
    fs.component("cover", ln),
    fs.component("drop", un),
    fs.component("dropdown", dn),
    fs.component("formCustom", hn),
    fs.component("gif", pn),
    fs.component("grid", vn),
    fs.component("heightMatch", yn),
    fs.component("heightViewport", Tn),
    fs.component("icon", Dn),
    fs.component("img", Hn),
    fs.component("leader", Qn),
    fs.component("margin", fn),
    fs.component("modal", is),
    fs.component("nav", ns),
    fs.component("navbar", ss),
    fs.component("offcanvas", rs),
    fs.component("overflowAuto", as),
    fs.component("responsive", ls),
    fs.component("scroll", cs),
    fs.component("scrollspy", us),
    fs.component("scrollspyNav", ds),
    fs.component("sticky", hs),
    fs.component("svg", Sn),
    fs.component("switcher", ms),
    fs.component("tab", gs),
    fs.component("toggle", vs),
    fs.component("video", an),
    fs.component("close", On),
    fs.component("marker", _n),
    fs.component("navbarToggleIcon", _n),
    fs.component("overlayIcon", _n),
    fs.component("paginationNext", _n),
    fs.component("paginationPrevious", _n),
    fs.component("searchIcon", zn),
    fs.component("slidenavNext", Ln),
    fs.component("slidenavPrevious", Ln),
    fs.component("spinner", Nn),
    fs.component("totop", _n),
    fs.use(sn);
    var bs = {
        mixins: [Ji],
        props: {
        ...
        update: {
            write: function() {
                ...
                s.total <= 0 && (this.stop(),
                s.days = s.hours = s.minutes = s.seconds = 0),
                this.units.forEach(function(e) {
    ...
    var ys, ws = "uk-animation-target", xs = {
        props: {
            animation: Number
        },
        data: {
        ...
        methods: {
            animate: function(e) {
                ...
                Ht(this.target, "height", t),
                fi(window, i),
                Ve.all(s.map(function(e, t) {
    ...
    var Es = {
        ...
        methods: {
            ...
            setState: function(r, e) {
                ...
                ze(this.$el, "beforeFilter", [this, r]);
                var a = this.children;
                this.toggles.forEach(function(e) {
    ...
    function $s(e, t, i) {
        ...
        (s || H(o)) && (r ? s ? (delete i.filter[""],
        i.filter[r] = s) : (delete i.filter[r],
        (N(i.filter) || ""in i.filter) && (i.filter = {
            "": s || ""
        })) : i.filter = {
            "": s || ""
        }),
    ...
    function Is(e, t) {
        ...
        void 0 === t && (t = "%"),
        e += e ? t : "",
        Ze ? "translateX(" + e + ")" : "translate3d(" + e + ", 0, 0)"
    }
    function As(e) {
    ...
    var Ls = {
        mixins: [{
            ...
            created: function() {
                ...
                ["start", "move", "end"].forEach(function(e) {
                    ...
                    n[e] = function(e) {
                        var t = qe(e).x * (Qe ? -1 : 1);
                        n.prevPos = t !== n.pos ? n.pos : n.prevPos,
                        n.pos = t,
                        i(e)
                    }
                })
            ...
            methods: {
                start: function() {
                    ...
                    ,
                    De(window, "scroll", this.unbindMove),
                    De(document, st, this.end, !0),
                    Ht(this.list, "userSelect", "none")
                },
                move: function(e) {
                    var t = this;
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            Ht(this.list, "pointerEvents", "none"),
                            e.cancelable && e.preventDefault(),
                            this.dragging = !0,
                            this.dir = i < 0 ? 1 : -1;
                            for (var n = this.slides, s = this.prevIndex, r = Math.abs(i), o = this.getIndex(s + this.dir, s), a = this._getDistance(s, o) || n[s].offsetWidth; o !== s && a < r; )
                            ...
                            this.percent = r / a;
                            var l, c = n[s], u = n[o], d = this.index !== o, h = s === o;
                            ...
                            (this.index === s && this.prevIndex !== s || l) && ze(n[this.index], "itemshown", [this]),
                            d && (this.prevIndex = s,
                            this.index = o,
                            h || ze(c, "beforeitemhide", [this]),
                            ze(u, "beforeitemshow", [this])),
                            this._transitioner = this._translate(Math.abs(this.percent), c, !h && u),
                            d && (h || ze(c, "itemhide", [this]),
                            ze(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
                    if (_e(window, "scroll", this.unbindMove),
                    this.unbindMove && this.unbindMove(),
                    _e(document, st, this.end, !0),
                    this.dragging)
                        ...
                        this.index === this.prevIndex)
                            ...
                            this.show(0 < this.dir && !e || this.dir < 0 && e ? "next" : "previous", !0)
                        }
                    Ht(this.list, {
                        userSelect: "",
                        pointerEvents: ""
            ...
            update: {
                write: function() {
                    ...
                    _t(kt(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                    this.updateNav()
                },
                events: ["resize"]
            },
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(e) {
                        ...
                        _t(e, i.clsActive, F(t) === n),
                        _t(e, "uk-invisible", i.finite && ("previous" === t && 0 === n || "next" === t && n >= i.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
                ...
                !this.dragging && this.length) {
                    ...
                    !t && 1 < n.length)
                        ...
                        if (a !== c) {
                            ...
                            this.prevIndex = o,
                            this.index = l,
                            a && ze(a, "beforeitemhide", [this]),
                            !ze(c, "beforeitemshow", [this, a]))
                                return this.index = this.prevIndex,
                                void r();
                            var u = this._show(a, c, t).then(function() {
                                return a && ze(a, "itemhidden", [i]),
                                ze(c, "itemshown", [i]),
                                new Ve(function(e) {
                                    wi.write(function() {
                                        n.shift(),
            ...
            getIndex: function(e, t) {
                return void 0 === e && (e = this.index),
                void 0 === t && (t = this.index),
                Q(ut(e, this.slides, t, this.finite), 0, this.maxIndex)
            },
            ...
            _getTransitioner: function(e, t, i, n) {
                ...
                new this.Transitioner(z(e) ? this.slides[e] : e,z(t) ? this.slides[t] : t,i * (Qe ? -1 : 1),n)
            }
        }
    };
    function zs(e) {
            ...
            Transitioner: function(r, o, a, e) {
                ...
                return {
                    ...
                    forward: function(e, t) {
                        return void 0 === t && (t = this.percent()),
                        Xt.cancel([o, r]),
                        this.show(e, t, !0)
                    },
                    translate: function(e) {
      ...
      , Ns = {
        ...
        events: [{
            ...
            handler: function(e) {
                ...
                this.animation = Ds.scale,
                Pt(e.target, this.clsActive),
            ...
            handler: function(e) {
                ...
                Ht(this.caption, "display", i ? "" : "none"),
                ht(this.caption, i);
                for (var n = 0; n <= this.preload; n++)
                    this.loadItem(this.getIndex(t + n)),
                    this.loadItem(this.getIndex(t - n))
            }
        }, {
            name: "itemshown",
            ...
            handler: function(e, s) {
                var r, o = this, t = s.source, i = s.type, n = s.alt;
                if (this.setItem(s, "<span uk-spinner></span>"),
                t)
                    if ("image" === i || t.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i))
                        Ke(t).then(function(e) {
                        ...
                        ne(a, "src", t),
                        Le(a, "error loadedmetadata", function(e) {
                    ...
                    } else if ("iframe" === i || t.match(/\.(html|php)($|\?)/i))
                        this.setItem(s, '<iframe class="uk-lightbox-iframe" src="' + t + '" frameborder="0" allowfullscreen></iframe>');
                    else if (r = t.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/watch\?v=([^&\s]+)/) || t.match(/()youtu\.be\/(.*)/)) {
                        var l = r[2]
                          , c = function(e, t) {
                            return void 0 === e && (e = 640),
                            void 0 === t && (t = 450),
                            o.setItem(s, Hs("https://www.youtube" + (r[1] || "") + ".com/embed/" + l, e, t, o.videoAutoplay))
                        };
                        ...
                        (r = t.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && Ue("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(t), {
                            responseType: "json",
                            withCredentials: !1
                        }).then(function(e) {
                            var t = e.response
        ...
        methods: {
            ...
            showControls: function() {
                ...
                Mt(this.$el, "uk-active", "uk-transition-active")
            },
    ...
    function js(i) {
        return ["href", "caption", "type", "poster", "alt"].reduce(function(e, t) {
            return e["href" === t ? "source" : t] = oe(i, t),
            e
        }, {})
    }
    var qs = {}
      , Rs = {
        ...
        connected: function() {
            var e, t = this, i = j(Ht(this.$el, this.marginProp));
        ...
        events: (Bs = {
            click: function(e) {
                xe(e.target, 'a[href="#"],a[href=""]') && e.preventDefault(),
                this.close()
            }
        },
        Bs[rt] = function() {
        ...
        methods: {
            close: function(e) {
                function t() {
                    ze(i.$el, "close", [i]),
                    vt(i.$el),
                    qs[i.pos].children.length || Ht(qs[i.pos], "display", "none")
                }
                var i = this;
                this.timer && clearTimeout(this.timer),
                e ? t() : Xt.start(this.$el, this.startProps).then(t)
            }
        }
    };
        ...
        computed: {
            props: function(m, g) {
                ...
                return Vs.reduce(function(e, t) {
                    if (H(m[t]))
                        return e;
                    var i, n, s, r = t.match(/color/i), o = r || "opacity" === t, a = m[t].slice(0);
                    o && Ht(g, t, ""),
                    a.length < 2 && a.unshift(("scale" === t ? 1 : o ? Ht(g, t) : 0) || 0);
                    var l = function(e) {
                        return e.reduce(function(e, t) {
                    ...
                    if (r) {
                        ...
                        Ht(g, "background-position-" + t[2], ""),
                        n = Ht(g, "backgroundPosition").split(" ")["x" === t[2] ? 0 : 1],
                        v.covers) {
                    ...
                    if ("stroke" === t) {
                        if (!a.some(function(e) {
                            ...
                            return e;
                        var f = Mn(v.$el);
                        Ht(g, "strokeDasharray", f),
                        "%" === l && (a = a.map(function(e) {
                            return e * f / 100
                        })),
                        a = a.reverse(),
                        t = "strokeDashoffset"
            ...
            covers: function(e, t) {
                return function(e) {
                    ...
                    return e.style.backgroundSize = t,
                    i
                }(t)
            }
        },
                ...
                e.active) {
                    if (!e.image && this.covers && this.bgProps.length) {
                        ...
                        if (t) {
                            var i = new Image;
                            i.src = t,
                            (e.image = i).naturalWidth || (i.onload = function() {
                                return l.$emit()
                            }
                            )
                        }
        ...
        methods: {
            ...
            getCss: function(d) {
                ...
                return Object.keys(h).reduce(function(e, t) {
                    ...
                    case "y":
                        s = s || "px",
                        e.transform += " translate" + f(t) + "(" + j(o).toFixed("px" === s ? 0 : 2) + s + ")";
                        break;
                    case "rotate":
                        s = s || "deg",
                        e.transform += " rotate(" + (o + s) + ")";
                        break;
                    case "scale":
                        e.transform += " scale(" + o + ")";
                        break;
                    ...
                    case "hue":
                        s = s || "deg",
                        e.filter += " hue-rotate(" + (o + s) + ")";
                        break;
                    case "fopacity":
                        s = s || "%",
                        e.filter += " opacity(" + (o + s) + ")";
                        break;
                    case "grayscale":
                    case "invert":
                    case "saturate":
            ...
            Transitioner: function(s, n, r, e) {
                ...
                return {
                    ...
                    translate: function(e) {
                        ...
                        Ht(a, "transform", Is(Q(t - t * e - c, -Zs(a), Js(a).width) * (Qe ? -1 : 1), "px")),
                        this.updateTranslates(),
                        s && (e = Q(e, -1, 1),
                        er(this.getItemIn(), "itemtranslatein", {
                            percent: e,
                            dir: r
                        }),
        ...
        computed: {
            ...
            maxIndex: function() {
                ...
                for (var e = Ks(this.list), t = this.length; t--; )
                    if (Qs(this.list.children[t], this.list) < e)
            ...
            sets: function(e) {
                ...
                return !N(t = t && this.slides.reduce(function(e, t, i) {
                    var n = Js(t).width;
                    if (a < c + n && (!r.center && i > r.maxIndex && (i = r.maxIndex),
                    !w(e, i))) {
                        var s = r.slides[i + 1];
                        r.center && s && n < l - Js(s).width / 2 ? l -= n : (l = o,
                        e.push(i),
                        a = c + o + (r.center ? n / 2 : 0))
                    }
                    return c += n,
                    e
                }, [])) && t
        ...
        events: {
            beforeitemshow: function(e) {
                ...
                if (!this.dragging && 1 < t) {
                    ...
                    this.duration = zs(this.avgWidth / this.velocity) * (Js(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth),
                    this.reorder()
            },
            itemshow: function() {
        ...
        events: [{
            ...
            handler: function(e) {
                var t = e.type
                  ...
                  , o = i.dir;
                Xt.cancel(this.$el),
                Ht(this.$el, this.getCss(rr(t, o, n))),
                Xt.start(this.$el, this.getCss(sr(t) ? .5 : 0 < o ? 1 : 0), s, r).catch(J)
            }
        }, {
            ...
            handler: function(e) {
                var t = e.type
                  ...
                  , s = i.dir;
                Xt.cancel(this.$el),
                Ht(this.$el, this.getCss(rr(t, s, n)))
            }
        }]
    };
    function sr(e) {
    ...
    var or, ar = G({}, Ms, {
        ...
        update: {
            read: function() {
                var e = this.ratio.split(":").map(Number)
                  , t = e[0]
                  , i = e[1];
                return i = i * this.list.offsetWidth / t || 0,
        ...
        update: {
            write: function() {
                if (this.clsEmpty && _t(this.$el, this.clsEmpty, N(this.$el.children)),
                Ht(this.handle ? kt(this.handle, this.$el) : this.$el.children, {
                    touchAction: "none",
                    userSelect: "none"
                }),
                this.drag) {
                    ...
                    function o(e) {
                        ...
                        var l = e.y;
                        clearTimeout(or);
                        (t = document.elementFromPoint(a - window.pageXOffset, l - window.pageYOffset),
                        i = hr(),
                        function(e, t) {
                            var i = [];
                            for (; t(e) && i.unshift(e),
                            ...
                            var n = ti(e)
                              , s = n.top
                              , r = n.bottom;
                            if (s < l && l < s + 30 ? t -= 5 : l < r && r - 20 < l && (t += 5),
                            0 < t && t < i)
                                return or = setTimeout(function() {
                                    fi(e, t),
                                    o({
                                        x: a,
                                        y: l
        ...
        methods: {
            init: function(e) {
                ...
                !s || n || 0 < i || Pe(t) || Ae(t, "." + this.clsNoDrag) || this.handle && !Ae(t, this.handle) || (e.preventDefault(),
                this.touched = [this],
                this.placeholder = s,
                this.origin = G({
                    target: t,
                ...
                De(document, nt, this.move),
                De(document, st, this.end),
                De(window, "scroll", this.scroll),
                this.threshold || this.start(e))
            },
            start: function(e) {
                this.drag = pt(this.$container, this.placeholder.outerHTML.replace(/^<li/i, "<div").replace(/li>$/i, "div>")),
                Ht(this.drag, G({
                    boxSizing: "border-box",
                    width: this.placeholder.offsetWidth,
                    height: this.placeholder.offsetHeight,
                    overflow: "hidden"
                }, Ht(this.placeholder, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
                ne(this.drag, "uk-no-boot", ""),
                Mt(this.drag, this.clsDrag, this.clsCustom),
                si(this.drag.firstElementChild, si(this.placeholder.firstElementChild));
                ...
                Mt(this.placeholder, this.clsPlaceholder),
                Mt(this.$el.children, this.clsItem),
                Mt(document.documentElement, this.clsDragState),
                ze(this.$el, "start", [this, this.placeholder]),
                this.move(e)
            },
            move: function(e) {
                if (this.drag) {
                    ...
                    if (i && !Ae(t, this.placeholder) && (!s || i.group && i.group === n.group)) {
                        ...
                        s)
                            ...
                            return;
                        i.insert(this.placeholder, t),
                        w(this.touched, i) || this.touched.push(i)
                    }
                } else
                    (Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(e)
            },
            end: function(e) {
                if (_e(document, nt, this.move),
                _e(document, st, this.end),
                _e(window, "scroll", this.scroll),
                this.drag) {
                    clearTimeout(or);
                    var t = this.getSortable(this.placeholder);
                    this === t ? this.origin.index !== ct(this.placeholder) && ze(this.$el, "moved", [this, this.placeholder]) : (ze(t.$el, "added", [t, this.placeholder]),
                    ze(this.$el, "removed", [this, this.placeholder])),
                    ze(this.$el, "stop", [this, this.placeholder]),
                    vt(this.drag),
                    this.drag = null;
                    ...
                    "touchend" === e.type && e.target.click()
            },
            scroll: function() {
                var e = window.pageYOffset;
                e !== this.scrollY && (this.pos.y += e - this.scrollY,
                this.scrollY = e,
                this.$emit())
            },
            insert: function(e, t) {
    ...
    var pr, fr, mr, gr = [], vr = {
        ...
        beforeConnect: function() {
            this._hasTitle = se(this.$el, "title"),
            ne(this.$el, {
                title: "",
                "aria-expanded": !1
            })
        ...
        methods: {
            show: function() {
                ...
                gr.push(this),
                this._unbind = De(document, st, function(e) {
            ...
            hide: function() {
                this.isActive() && !ye(this.$el, "input:focus") && (gr.splice(gr.indexOf(this), 1),
                clearTimeout(this.showTimer),
                clearInterval(this.hideTimer),
                ne(this.$el, "aria-expanded", !1),
                this.toggleElement(this.tooltip, !1),
                this.tooltip && vt(this.tooltip),
                this.tooltip = !1,
                this._unbind())
            },
            _show: function() {
                this.tooltip = pt(this.container, '<div class="' + this.clsPos + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"),
        ...
        events: {
            change: function(e) {
                ye(e.target, 'input[type="file"]') && (e.preventDefault(),
            ...
            drop: function(e) {
                ...
                t && t.files && (Pt(this.$el, this.clsDragover),
                this.upload(t.files))
            },
            ...
            dragover: function(e) {
                wr(e),
                Mt(this.$el, this.clsDragover)
            },
            dragleave: function(e) {
                wr(e),
                Pt(this.$el, this.clsDragover)
            }
        },
        methods: {
            upload: function(e) {
                      ...
                      , r = function(e) {
                        ...
                        Ue(n.url, {
                            ...
                            beforeSend: function(e) {
                                var t = e.xhr;
                                t.upload && De(t.upload, "progress", n.progress),
                                ["loadStart", "load", "loadEnd", "abort"].forEach(function(e) {
                            ...
                            n.complete(e),
                            s.length ? r(s.shift()) : n.completeAll(e)
                        }, function(e) {
                            return n.error(e)
                        })
                    };
    ...
    function Tr(e) {
        ...
        ("attributes" !== e.type ? function(e) {
            for (var t = e.addedNodes, i = e.removedNodes, n = 0; n < t.length; n++)
                Cr(t[n], fr);
    ...
    return Ni.component("countdown", bs),
    Ni.component("filter", Es),
    Ni.component("lightbox", Fs),
    Ni.component("lightboxPanel", Ns),
    Ni.component("notification", Rs),
    Ni.component("parallax", Xs),
    Ni.component("slider", ir),
    Ni.component("sliderParallax", nr),
    Ni.component("slideshow", lr),
    Ni.component("slideshowParallax", nr),
    Ni.component("sortable", cr),
    Ni.component("tooltip", vr),
    Ni.component("upload", br),
    fr = (pr = Ni).connect,
    mr = pr.disconnect,
    "MutationObserver"in window && (document.body ? wi.read(xr) : new MutationObserver(function() {
...
function(e, t) {
    ...
    var r = function() {
        ...
        for (var t = function(e) {
            for (var t in e)
                e.hasOwnProperty(t) && (n && "[object Object]" === Object.prototype.toString.call(e[t]) ? i[t] = r(i[t], e[t]) : i[t] = e[t])
    ...
    return function(e) {
        var t, i = {
            ...
            watch: function() {
                this.switch(),
                n.matchMedia("(min-width:" + t.breakpoint + "px)").addListener(i.switch)
            },
            init: function(e) {
                t = function(e) {
                    switch (e.breakpoint) {
...
function(e) {
    ...
    u.widget = function(e, i, t) {
        var n, s, r, o = {}, a = e.split(".")[0], l = a + "-" + (e = e.split(".")[1]);
        return t || (t = i,
        i = u.Widget),
    ...
    u.widget.bridge = function(r, t) {
        ...
        u.fn[r] = function(i) {
            ...
            this.each(function() {
                var e = u.data(this, o);
                e ? (e.option(i || {}),
                e._init && e._init()) : u.data(this, o, new t(i,this))
            })),
            s
        }
    }
    ...
    u.Widget.prototype = {
        ...
        _on: function(o, a, e) {
            ...
            u.each(e, function(e, t) {
                function i() {
                    if (o || !0 !== c.options.disabled && !u(this).hasClass("ui-state-disabled"))
    ...
    u.each({
        ...
        u.Widget.prototype["_" + r] = function(t, e, i) {
            ...
            n && u.effects && u.effects.effect[s] ? t[r](e) : s !== r && t[s] ? t[s](e.duration, e.easing, i) : t.queue(function(e) {
                u(this)[r](),
                i && i.call(t[0]),
                e()
            })
    ...
    u.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(e) {
                ...
                if (!0 === u.data(e.target, t.widgetName + ".preventClickEvent"))
                    return u.removeData(e.target, t.widgetName + ".preventClickEvent"),
                    e.stopImmediatePropagation(),
                    !1
            }),
            this.started = !1
        ...
        _mouseDown: function(e) {
            if (!r) {
                ...
                !0) : (!0 === u.data(e.target, this.widgetName + ".preventClickEvent") && u.removeData(e.target, this.widgetName + ".preventClickEvent"),
        ...
        _mouseMove: function(e) {
            if (this._mouseMoved) {
                if (u.ui.ie && (!document.documentMode || document.documentMode < 9) && !e.button)
        ...
        _mouseUp: function(e) {
            ...
            e.target === this._mouseDownEvent.target && u.data(e.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(e)),
    ...
    u.widget("ui.slider", u.ui.mouse, {
        ...
        _createHandles: function() {
            var e, t, i = this.options, n = this.element.find(".ui-slider-handle"), s = [];
            for (t = i.values && i.values.length || 1,
            n.length > t && (n.slice(t).remove(),
            n = n.slice(0, t)),
            e = n.length; e < t; e++)
        ...
        _createRange: function() {
            var e = this.options;
            e.range ? (!0 === e.range && (e.values ? e.values.length && 2 !== e.values.length ? e.values = [e.values[0], e.values[0]] : u.isArray(e.values) && (e.values = e.values.slice(0)) : e.values = [this._valueMin(), this._valueMin()]),
        ...
        _mouseCapture: function(e) {
            var t, i, n, s, r, o, a, l = this, c = this.options;
            ...
            this.handles.each(function(e) {
                ...
                (t < n || n === t && (e === l._lastChangedValue || l.values(e) === c.min)) && (n = t,
                s = u(this),
                r = e)
            }),
        ...
        _trimAlignValue: function(e) {
            ...
            var t = 0 < this.options.step ? this.options.step : 1
              ...
              , n = e - i;
            return 2 * Math.abs(i) >= t && (n += 0 < i ? t : -t),
        ...
        _refreshValue: function() {
            var t, i, e, n, s, r = this.options.range, o = this.options, a = this, l = !this._animateOff && o.animate, c = {};
...
function(l, c, m, g) {
    ...
    m)
        if (m.fn.fancybox)
            ...
            }, r = m(l), o = m(c), a = 0, h = l.requestAnimationFrame || l.webkitRequestAnimationFrame || l.mozRequestAnimationFrame || l.oRequestAnimationFrame || function(e) {
            ...
            , d = function() {
                var e, t = c.createElement("fakeelement"), i = {
            ...
            m.extend(v.prototype, {
                init: function() {
                    ...
                    !m.fancybox.getInstance() && !1 !== s.hideScrollbar && !m.fancybox.isMobile && c.body.scrollHeight > l.innerHeight && (m("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (l.innerWidth - c.documentElement.clientWidth) + "px;}</style>"),
                    m("body").addClass("compensate-for-scrollbar")),
                    i = "",
                    m.each(s.buttons, function(e, t) {
                        i += s.btnTpl[t] || ""
                    }),
                    t = m(n.translate(n, s.baseTpl.replace("{{buttons}}", i).replace("{{arrows}}", s.btnTpl.arrowLeft + s.btnTpl.arrowRight))).attr("id", "fancybox-container-" + n.id).addClass(s.baseClass).data("FancyBox", n).appendTo(s.parentEl),
                    n.$refs = {
                        container: t
                    },
                ...
                addContent: function(e) {
                    ...
                    m.each(i, function(e, t) {
                        var i, n, s, r, o, a = {}, l = {};
                        m.isPlainObject(t) ? l = (a = t).opts || t : "object" === m.type(t) && m(t).length ? (l = (i = m(t)).data() || {},
                        ...
                        r = a.src || "",
                        !n && r && ((s = r.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (n = "video",
                        a.opts.video.format || (a.opts.video.format = "video/" + ("ogv" === s[1] ? "ogg" : s[1]))) : r.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? n = "image" : r.match(/\.(pdf)((\?|#).*)?$/i) ? (n = "iframe",
                        a = m.extend(!0, a, {
                            contentType: "pdf",
                            opts: {
                                iframe: {
                        ...
                        "function" === m.type(a.opts.caption) && (a.opts.caption = a.opts.caption.apply(t, [c, a])),
                        "function" === m.type(c.opts.caption) && (a.opts.caption = c.opts.caption.apply(t, [c, a])),
                        ...
                        a.opts.modal && (a.opts = m.extend(!0, a.opts, {
                            trapFocus: !0,
                            infobar: 0,
                            toolbar: 0,
                            smallBtn: 0,
                ...
                addEvents: function() {
                    ...
                    r.on("orientationchange.fb resize.fb", function(e) {
                        e && e.originalEvent && "resize" === e.originalEvent.type ? (n.requestId && u(n.requestId),
                    ...
                    o.on("keydown.fb", function(e) {
                        ...
                        if (9 != i) {
                            if (!(!t.opts.keyboard || e.ctrlKey || e.altKey || e.shiftKey || m(e.target).is("input,textarea,video,audio,select")))
                                ...
                                void n.close(e)) : 37 === i || 38 === i ? (e.preventDefault(),
                                void n.previous()) : 39 === i || 40 === i ? (e.preventDefault(),
                                void n.next()) : void n.trigger("afterKeydown", e, i)
                        } else
                ...
                jumpTo: function(e, n) {
                    var t, i, s, r, o, a, l, c, u, d = this, h = d.group.length;
                    if (!(d.isDragging || d.isClosing || d.isAnimating && d.firstRun)) {
                        if (e = parseInt(e, 10),
                        !(s = d.current ? d.current.opts.loop : d.opts.loop) && (e < 0 || h <= e))
                            return !1;
                        ...
                        d.prevPos = d.currPos,
                        r = d.createSlide(e),
                        1 < h && ((s || r.index < h - 1) && d.createSlide(e + 1),
                        (s || 0 < r.index) && d.createSlide(e - 1)),
                        d.current = r,
                        d.currIndex = r.index,
                        d.currPos = r.pos,
                        ...
                        d.updateControls(),
                        r.forcedDuration = g,
                        m.isNumeric(n) ? r.forcedDuration = n : n = r.opts[t ? "animationDuration" : "transitionDuration"],
                        n = parseInt(n, 10),
                        i = d.isMoved(r),
                        r.$slide.addClass("fancybox-slide--current"),
                        t)
                            return r.opts.animationEffect && n && d.$refs.container.css("transition-duration", n + "ms"),
                        ...
                        i ? (u = a.left - (o.pos * a.width + o.pos * o.opts.gutter),
                        m.each(d.slides, function(e, t) {
                        ...
                        })) : n && r.opts.transitionEffect && (c = "fancybox-animated fancybox-fx-" + r.opts.transitionEffect,
                        o.$slide.addClass("fancybox-slide--" + (o.pos > r.pos ? "next" : "previous")),
                        m.fancybox.animate(o.$slide, c, n, function() {
                ...
                createSlide: function(e) {
                    var t, i, n = this;
                    return i = (i = e % n.group.length) < 0 ? n.group.length + i : i,
                    !n.slides[e] && n.group[i] && (t = m('<div class="fancybox-slide"></div>').appendTo(n.$refs.stage),
                ...
                scaleToActual: function(e, t, i) {
                    var n, s, r, o, a, l = this, c = l.current, u = c.$content, d = m.fancybox.getTranslate(c.$slide).width, h = m.fancybox.getTranslate(c.$slide).height, p = c.width, f = c.height;
                    l.isAnimating || l.isMoved() || !u || "image" != c.type || !c.isLoaded || c.hasError || (l.isAnimating = !0,
                    m.fancybox.stop(u),
                    e = e === g ? .5 * d : e,
                    t = t === g ? .5 * h : t,
                    (n = m.fancybox.getTranslate(u)).top -= m.fancybox.getTranslate(c.$slide).top,
                    n.left -= m.fancybox.getTranslate(c.$slide).left,
                    o = p / n.width,
                    a = f / n.height,
                    s = .5 * d - .5 * p,
                    r = .5 * h - .5 * f,
                    d < p && (0 < (s = n.left * o - (e * o - e)) && (s = 0),
                    s < d - p && (s = d - p)),
                    h < f && (0 < (r = n.top * a - (t * a - t)) && (r = 0),
                    r < h - f && (r = h - f)),
                    l.updateCursor(p, f),
                ...
                scaleToFit: function(e) {
                    ...
                    i.isAnimating || i.isMoved() || !s || "image" != n.type || !n.isLoaded || n.hasError || (i.isAnimating = !0,
                    m.fancybox.stop(s),
                    t = i.getFitPos(n),
                ...
                getFitPos: function(e) {
                    var t, i, n, s, r = e.$content, o = e.$slide, a = e.width || e.opts.width, l = e.height || e.opts.height, c = {};
                    ...
                    i -= parseFloat(o.css("paddingTop")) + parseFloat(o.css("paddingBottom")) + parseFloat(r.css("marginTop")) + parseFloat(r.css("marginBottom")),
                    a && l || (a = t,
                    l = i),
                    t - .5 < (a *= n = Math.min(1, t / a, i / l)) && (a = t),
                    i - .5 < (l *= n) && (l = i),
                    "image" === e.type ? (c.top = Math.floor(.5 * (i - l)) + parseFloat(o.css("paddingTop")),
                    c.left = Math.floor(.5 * (t - a)) + parseFloat(o.css("paddingLeft"))) : "video" === e.contentType && (a / (s = e.opts.width && e.opts.height ? a / l : e.opts.ratio || 16 / 9) < l ? l = a / s : l * s < a && (a = l * s)),
                    c.width = a,
                    c.height = l,
                    c)
                },
                ...
                updateSlide: function(e, t) {
                    var i = this
                      ...
                      , o = e.$slide;
                    i.adjustCaption(e),
                    n && (s || r || "video" === e.contentType) && !e.hasError && (m.fancybox.stop(n),
                ...
                isMoved: function(e) {
                    ...
                    return !!n && (i = m.fancybox.getTranslate(this.$refs.stage),
                    t = m.fancybox.getTranslate(n.$slide),
                    !n.$slide.hasClass("fancybox-animated") && (.5 < Math.abs(t.top - i.top) || .5 < Math.abs(t.left - i.left)))
                },
                updateCursor: function(e, t) {
                    var i, n, s = this.current, r = this.$refs.container;
                    ...
                    n = !!(i = this.canPan(e, t)) || this.isZoomable(),
                    r.toggleClass("fancybox-is-zoomable", n),
                    m("[data-fancybox-zoom]").prop("disabled", !n),
                    i ? r.addClass("fancybox-can-pan") : n && ("zoom" === s.opts.clickContent || m.isFunction(s.opts.clickContent) && "zoom" == s.opts.clickContent(s)) ? r.addClass("fancybox-can-zoomIn") : s.opts.touch && (s.opts.touch.vertical || 1 < this.group.length) && "video" !== s.contentType && r.addClass("fancybox-can-swipe"))
                },
                isZoomable: function() {
                ...
                isScaledDown: function(e, t) {
                    var i = !1
                      , n = this.current
                      , s = n.$content;
                    return e !== g && t !== g ? i = e < n.width && t < n.height : s && (i = (i = m.fancybox.getTranslate(s)).width < n.width && i.height < n.height),
                    i
                },
                canPan: function(e, t) {
                    var i = this.current
                    ...
                    n && s && (s = 1.5 < Math.abs(n.width - s.width) || 1.5 < Math.abs(n.height - s.height))),
                    s
                },
                loadSlide: function(i) {
                    ...
                    if (!i.isLoading && !i.isLoaded) {
                        ...
                        case "ajax":
                            s.showLoading(i),
                            n = m.ajax(m.extend({}, i.opts.ajax.settings, {
                                url: i.src,
                ...
                setBigImage: function(t) {
                    ...
                    t.$image = n.one("error", function() {
                        ...
                        i.afterLoad(t)),
                        i.isClosing || (t.opts.srcset && ((e = t.opts.sizes) && "auto" !== e || (e = (1 < t.width / t.height && 1 < r.width() / r.height() ? "100" : Math.round(t.width / t.height * 100)) + "vw"),
                ...
                setIframe: function(s) {
                    var r, t = this, o = s.opts.iframe, a = s.$slide;
                    s.$content = m('<div class="fancybox-content' + (o.preload ? " fancybox-is-hidden" : "") + '"></div>').css(o.css).appendTo(a),
                    a.addClass("fancybox-slide--" + s.contentType),
                    s.$iframe = r = m(o.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(o.attr).appendTo(s.$content),
                    ...
                    a.on("refresh.fb", function() {
                        var e, t = s.$content, i = o.css.width, n = o.css.height;
                        if (1 === r[0].isReady) {
                            try {
                            ...
                            n === g && (n = Math.ceil(Math.max(e[0].clientHeight, e.outerHeight(!0)))),
                            t.css("height", n || ""),
                            a.css("overflow", "auto")),
                ...
                adjustCaption: function(e) {
                    var t, i = e || this.current, n = i.opts.caption, s = i.opts.preventCaptionOverlap, r = this.$refs.caption, o = !1;
                    r.toggleClass("fancybox-caption--separate", s),
                    s && n && n.length && (i.pos !== this.currPos ? ((t = r.clone().appendTo(r.parent())).children().eq(0).empty().html(n),
                    o = t.outerHeight(!0),
                    t.empty().remove()) : this.$caption && (o = this.$caption.outerHeight(!0)),
                ...
                adjustLayout: function(e) {
                    ...
                    0 < parseFloat(s) && (t = r.$slide[0].scrollHeight,
                    r.$slide.css("padding-bottom", 0),
                    Math.abs(t - r.$slide[0].scrollHeight) < 1 && (i = s),
                    r.$slide.css("padding-bottom", n))),
                    r.$content.css("margin-bottom", i))
                },
                revealContent: function(e) {
                    var t, i, n, s, r = this, o = e.$slide, a = !1, l = !1, c = r.isMoved(e), u = e.isRevealed;
                    return e.isRevealed = !0,
                    t = e.opts[r.firstRun ? "animationEffect" : "transitionEffect"],
                    n = e.opts[r.firstRun ? "animationDuration" : "transitionDuration"],
                    n = parseInt(e.forcedDuration === g ? n : e.forcedDuration, 10),
                    !c && e.pos === r.currPos && n || (t = !1),
                    "zoom" === t && (e.pos === r.currPos && n && "image" === e.type && !e.hasError && (l = r.getThumbPos(e)) ? a = r.getFitPos(e) : t = "fade"),
                    "zoom" === t ? (r.isAnimating = !0,
                    a.scaleX = a.width / l.width,
                    a.scaleY = a.height / l.height,
                    "auto" == (s = e.opts.zoomOpacity) && (s = .1 < Math.abs(e.width / e.height - l.width / l.height)),
                    s && (l.opacity = .1,
                    a.opacity = 1),
                    m.fancybox.setTranslate(e.$content.removeClass("fancybox-is-hidden"), l),
                    p(e.$content),
                    void m.fancybox.animate(e.$content, a, n, function() {
                        r.isAnimating = !1,
                        r.complete()
                    })) : (r.updateSlide(e),
                    t ? (m.fancybox.stop(o),
                    ...
                    void m.fancybox.animate(o, "fancybox-slide--current", n, function() {
                        o.removeClass(i).css({
                            transform: "",
                            opacity: ""
                        }),
                ...
                getThumbPos: function(e) {
                    ...
                    return !(!a || !function(e) {
                        ...
                        i = c.elementFromPoint(t.x, t.y) === e,
                        m(".fancybox-container").css("pointer-events", ""),
                        i)
                    }(a[0])) && (i = m.fancybox.getTranslate(a),
                    n = parseFloat(a.css("border-top-width") || 0),
                    s = parseFloat(a.css("border-right-width") || 0),
                    r = parseFloat(a.css("border-bottom-width") || 0),
                    o = parseFloat(a.css("border-left-width") || 0),
                    t = {
                        top: i.top + n,
                        left: i.left + o,
                        width: i.width - s - o,
                ...
                complete: function() {
                    ...
                    m.each(i.slides, function(e, t) {
                        t.pos >= i.currPos - 1 && t.pos <= i.currPos + 1 ? n[t.pos] = t : t && (m.fancybox.stop(t.$slide),
                        t.$slide.off().remove())
                    }),
                    i.slides = n),
                    i.isAnimating = !1,
                ...
                focus: function(e, t) {
                    ...
                    })).length ? (n = i.index(c.activeElement),
                    e && e.shiftKey ? (n < 0 || 0 == n) && (e.preventDefault(),
                    i.eq(i.length - 1).trigger("focus")) : (n < 0 || n == i.length - 1) && (e && e.preventDefault(),
                ...
                close: function(e, t) {
                    ...
                    var n, s, r, o, a, l, c, u = this, d = u.current;
                    ...
                    u.hideControls(!0),
                    u.updateCursor(),
                    "zoom" !== n || r && s && "image" === d.type && !u.isMoved() && !d.hasError && (c = u.getThumbPos(d)) || (n = "fade"),
                    "zoom" === n ? (m.fancybox.stop(r),
                    l = {
                    ...
                    p(r),
                    m.fancybox.animate(r, c, s, i)) : n && s ? m.fancybox.animate(d.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, s, i) : !0 === e ? setTimeout(i, s) : i(),
                    !0))
                },
                cleanUp: function(e) {
                ...
                trigger: function(e, t) {
                    ...
                    if (s ? n.unshift(s) : s = this,
                    n.unshift(this),
                    m.isFunction(s.opts[e]) && (i = s.opts[e].apply(s, n)),
                    !1 === i)
                        return i;
                ...
                updateControls: function() {
                    ...
                    r && r.length ? (e.$caption = s).children().eq(0).html(r) : e.$caption = null,
                    e.hasHiddenControls || e.isIdle || e.showControls(),
                    n.find("[data-fancybox-count]").html(e.group.length),
                    n.find("[data-fancybox-index]").html(i + 1),
                    n.find("[data-fancybox-prev]").prop("disabled", !t.opts.loop && i <= 0),
                    n.find("[data-fancybox-next]").prop("disabled", !t.opts.loop && i >= e.group.length - 1),
                ...
                showControls: function() {
                    ...
                    t.toggleClass("fancybox-show-toolbar", !(!e.toolbar || !e.buttons)).toggleClass("fancybox-show-infobar", !!(e.infobar && 1 < this.group.length)).toggleClass("fancybox-show-caption", !!this.$caption).toggleClass("fancybox-show-nav", !!(e.arrows && 1 < this.group.length)).toggleClass("fancybox-is-modal", !!e.modal)
                },
            ...
            m.fancybox = {
                ...
                getInstance: function(e) {
                    ...
                    return t instanceof v && ("string" === m.type(e) ? t[e].apply(t, i) : "function" === m.type(e) && e.apply(t, i),
                    t)
                },
                open: function(e, t, i) {
                    return new v(e,t,i)
                ...
                use3d: (e = c.createElement("div"),
                l.getComputedStyle && l.getComputedStyle(e) && l.getComputedStyle(e).getPropertyValue("transform") && !(c.documentMode && c.documentMode < 11)),
                ...
                animate: function(t, i, n, s, r) {
                    ...
                    t.on(d, function(e) {
                        ...
                        m.isPlainObject(i) ? i.scaleX !== g && i.scaleY !== g && a.setTranslate(t, {
                            top: i.top,
                            left: i.left,
                    ...
                    m.isPlainObject(i) ? (i.scaleX !== g && i.scaleY !== g && (delete i.width,
                    delete i.height,
            ...
            ,
            o.on("click.fb-start", "[data-fancybox]", b),
            ...
            i = "fancybox-focus",
            n = null,
            o.on("mousedown mouseup focus blur", t, function(e) {
                switch (e.type) {
                case "mousedown":
                    n = m(this);
                    break;
                ...
                case "focusin":
                    m(t).removeClass(i),
                    m(this).is(n) || m(this).is("[disabled]") || m(this).addClass(i);
                    break;
                case "focusout":
                    m(t).removeClass(i)
                }
    ...
    function b(e, t) {
        ...
        (s = m.fancybox.getInstance()) && s.$trigger && s.$trigger.is(i) || (r = t.selector ? m(t.selector) : (n = i.attr("data-fancybox") || "") ? (r = e.data ? e.data.items : []).length ? r.filter('[data-fancybox="' + n + '"]') : m('[data-fancybox="' + n + '"]') : [i],
        (o = m(r).index(i)) < 0 && (o = 0),
        (s = m.fancybox.open(r, t, o)).$trigger = i))
    }
...
function(p) {
    ...
    p(document).on("objectNeedsType.fb", function(e, t, s) {
        ...
        p.each(i, function(e, t) {
            if (o = d.match(t.matcher)) {
                ...
                return a = p.extend(!0, {}, t.params, s.opts[e], c),
                d = "function" === p.type(t.url) ? t.url.call(this, o, a, s) : f(t.url, o, a),
                r = "function" === p.type(t.thumb) ? t.thumb.call(this, o, a, s) : f(t.thumb, o),
                "youtube" === e ? d = d.replace(/&t=((\d+)m)?(\d+)s/, function(e, t, i, n) {
                    return "&start=" + ((i ? 60 * parseInt(i, 10) : 0) + parseInt(n, 10))
                }) : "vimeo" === e && (d = d.replace("&%23", "#")),
                !1
            }
        }),
        h ? (s.opts.thumb || s.opts.$thumb && s.opts.$thumb.length || (s.opts.thumb = r),
    ...
    var s = {
        ...
        load: function(e) {
            ...
            (t = p.fancybox.getInstance()) && (i = t.current.$content.find("iframe"),
...
function(m, l, g) {
    ...
    function d(e) {
        for (var t, i, n, s, r, o = !1; t = e.get(0),
        void 0,
        i = m.getComputedStyle(t)["overflow-y"],
        n = m.getComputedStyle(t)["overflow-x"],
        s = ("scroll" === i || "auto" === i) && t.scrollHeight > t.clientHeight,
        r = ("scroll" === n || "auto" === n) && t.scrollWidth > t.clientWidth,
        !(o = s || r) && (e = e.parent()).length && !e.hasClass("fancybox-stage") && !e.is("body"); )
            ;
        return o
    }
    function i(e) {
        ...
        this.destroy(),
        this.$container.on("touchstart.fb.touch mousedown.fb.touch", g.proxy(this, "ontouchstart"))
    }
    ...
    i.prototype.destroy = function() {
        ...
        g(l).off(".fb.touch"),
        this.requestId && (y(this.requestId),
        this.requestId = null),
    ...
    i.prototype.ontouchstart = function(e) {
        var t = this
          ...
          , o = s.$content
          , a = "touchstart" == e.type;
        if (a && t.$container.off("mousedown.fb.touch"),
        (!e.originalEvent || 2 != e.originalEvent.button) && r.length && i.length && !c(i) && !c(i.parent()) && (i.is("img") || !(e.originalEvent.clientX > i[0].clientWidth + i.offset().left))) {
            if (!s || n.isAnimating || s.$slide.hasClass("fancybox-animated"))
                return e.stopPropagation(),
                void e.preventDefault();
            t.realPoints = t.startPoints = u(e),
            t.startPoints.length && (s.touch && e.stopPropagation(),
            t.startEvent = e,
            t.canTap = !0,
            t.$target = i,
            t.$content = o,
            ...
            g(l).off(".fb.touch").on(a ? "touchend.fb.touch touchcancel.fb.touch" : "mouseup.fb.touch mouseleave.fb.touch", g.proxy(t, "ontouchend")).on(a ? "touchmove.fb.touch" : "mousemove.fb.touch", g.proxy(t, "ontouchmove")),
            ...
            g.fancybox.isMobile && i.parents(".fancybox-caption").length)) && (t.isScrollable = d(i) || d(i.parent()),
            g.fancybox.isMobile && t.isScrollable || e.preventDefault(),
            1 !== t.startPoints.length && !s.hasError || (t.canPan ? (g.fancybox.stop(t.$content),
    ...
    i.prototype.ontouchmove = function(e) {
        var t = this;
        void 0 === e.originalEvent.buttons || 0 !== e.originalEvent.buttons ? t.isScrolling ? t.canTap = !1 : (t.newPoints = u(e),
    ...
    i.prototype.onSwipe = function(e) {
        var t, s = this, r = s.instance, i = s.isSwiping, n = s.sliderStartPos.left || 0;
        if (!0 !== i)
            "x" == i && (0 < s.distanceX && (s.instance.group.length < 2 || 0 === s.instance.current.index && !s.instance.current.opts.loop) ? n += Math.pow(s.distanceX, .8) : s.distanceX < 0 && (s.instance.group.length < 2 || s.instance.current.index === s.instance.group.length - 1 && !s.instance.current.opts.loop) ? n -= Math.pow(-s.distanceX, .8) : n += s.distanceX),
            s.sliderLastPos = {
                top: "x" == i ? 0 : s.sliderStartPos.top + s.distanceY,
                left: n
            },
            s.requestId && (y(s.requestId),
            s.requestId = null),
            ...
            if (s.canTap = !1,
            r.group.length < 2 && s.opts.vertical ? s.isSwiping = "y" : r.isDragging || !1 === s.opts.vertical || "auto" === s.opts.vertical && 800 < g(m).width() ? s.isSwiping = "x" : (t = Math.abs(180 * Math.atan2(s.distanceY, s.distanceX) / Math.PI),
            ...
            g.each(r.slides, function(e, t) {
                ...
                n = g.fancybox.getTranslate(r.$refs.stage),
                t.$slide.css({
                    transform: "",
                    opacity: "",
                    "transition-duration": ""
                ...
                t.pos === r.current.pos && (s.sliderStartPos.top = i.top - n.top,
    ...
    i.prototype.limitMovement = function() {
        var e, t, i, n, s, r, o = this.canvasWidth, a = this.canvasHeight, l = this.distanceX, c = this.distanceY, u = this.contentStartPos, d = u.left, h = u.top, p = u.width, f = u.height;
        return s = o < p ? d + l : d,
        r = h + c,
        e = Math.max(0, .5 * o - .5 * p),
        t = Math.max(0, .5 * a - .5 * f),
        i = Math.min(o - p, .5 * o - .5 * p),
        n = Math.min(a - f, .5 * a - .5 * f),
        0 < l && e < s && (s = e - 1 + Math.pow(-e + d + l, .8) || 0),
        l < 0 && s < i && (s = i + 1 - Math.pow(i - d - l, .8) || 0),
        0 < c && t < r && (r = t - 1 + Math.pow(-t + h + c, .8) || 0),
        c < 0 && r < n && (r = n + 1 - Math.pow(n - h - c, .8) || 0),
        {
            top: r,
            left: s
        }
    ...
    i.prototype.ontouchend = function(e) {
        ...
        n ? t.endPanning() : s ? t.endZooming() : t.endSwiping(i, r)
    }
    ,
    i.prototype.endSwiping = function(e, t) {
        ...
        n = i.instance.close(!0, 250)) : o && 0 < i.distanceX ? n = i.instance.previous(300) : o && i.distanceX < 0 && (n = i.instance.next(300)),
    ...
    i.prototype.endZooming = function() {
        var e, t, i, n, s = this, r = s.instance.current, o = s.newWidth, a = s.newHeight;
        ...
        o < s.canvasWidth && a < s.canvasHeight ? s.instance.scaleToFit(150) : o > r.width || a > r.height ? s.instance.scaleToActual(s.centerPointStartX, s.centerPointStartY, 150) : (i = s.limitPosition(e, t, o, a),
    ...
    i.prototype.onTap = function(i) {
        function e(e) {
            var t = o.opts[e];
            if (g.isFunction(t) && (t = t.apply(r, [o, i])),
            t)
                switch (t) {
                case "close":
        ...
        var t, n = this, s = g(i.target), r = n.instance, o = r.current, a = i && u(i) || n.startPoints, l = a[0] ? a[0].x - g(m).scrollLeft() - n.stagePos.left : 0, c = a[0] ? a[0].y - g(m).scrollTop() - n.stagePos.top : 0;
        if ((!i.originalEvent || 2 != i.originalEvent.button) && (s.is("img") || !(l > s[0].clientWidth + s.offset().left))) {
            ...
            if (n.tapped) {
                ...
                n.tapX = l,
                n.tapY = c,
                o.opts["dblclick" + t] && o.opts["dblclick" + t] !== o.opts["click" + t] ? n.tapped = setTimeout(function() {
                    n.tapped = null,
...
function(o, a) {
    ...
    a(o).on({
        ...
        "afterKeydown.fb": function(e, t, i, n, s) {
            var r = t && t.SlideShow;
            !r || !i.opts.slideShow || 80 !== s && 32 !== s || a(o.activeElement).is("button,a,input") || (n.preventDefault(),
            r.toggle())
        },
...
function(r, i) {
    ...
    i(r).on({
        "onInit.fb": function(e, t) {
            ...
            t.opts.fullScreen && !0 === t.opts.fullScreen.autoStart && s.request(),
            t.FullScreen = s) : t && t.$refs.toolbar.find("[data-fancybox-fullscreen]").hide() : t.$refs.toolbar.find("[data-fancybox-fullscreen]").remove()
        },
        "afterKeydown.fb": function(e, t, i, n, s) {
...
function(e, r) {
    ...
    r.extend(n.prototype, {
        ...
        init: function(e) {
            ...
            for (var s = 0, r = i.length; s < r && (i[s].thumb && n++,
            !(1 < n)); s++)
                ;
        ...
        create: function() {
            ...
            e.$grid || (e.$grid = r('<div class="' + o + " " + o + "-" + e.opts.axis + '"></div>').appendTo(t.$refs.container.find(n).addBack().filter(n)),
            ...
            r.each(t.group, function(e, t) {
                ...
                s.push('<a href="javascript:;" tabindex="0" data-index="' + e + '"' + (i && i.length ? ' style="background-image:url(' + i + ')"' : 'class="fancybox-thumbs-missing"') + "></a>")
            }),
        ...
        focus: function(e) {
            ...
            this.instance.current && (i = (t = n.children().removeClass(a).filter('[data-index="' + this.instance.current.index + '"]').addClass(a)).position(),
            "y" === this.opts.axis && (i.top < 0 || i.top > n.height() - t.outerHeight()) ? n.stop().animate({
    ...
    r(e).on({
        ...
        "afterKeydown.fb": function(e, t, i, n, s) {
            var r = t && t.Thumbs;
            r && r.isActive && 71 === s && (n.preventDefault(),
            r.toggle())
        },
        "beforeClose.fb": function(e, t) {
            var i = t && t.Thumbs;
...
function(e, s) {
    ...
    s(e).on("click", "[data-fancybox-share]", function() {
        ...
        n && ("function" === s.type(n.opts.share.url) && (e = n.opts.share.url.apply(n, [i, n])),
        t = n.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === n.type ? encodeURIComponent(n.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(e)).replace(/\{\{url_raw\}\}/g, function(e) {
            var t = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
...
function(r, o, s) {
    ...
    s(function() {
        !1 !== s.fancybox.defaults.hash && (s(o).on({
            "onInit.fb": function(e, t) {
                var i, n;
                !1 !== t.group[t.currIndex].opts.hash && (i = a(),
                (n = l(t)) && i.gallery && n == i.gallery && (t.currIndex = i.index - 1))
            },
            "beforeShow.fb": function(e, t, i, n) {
                var s;
                i && !1 !== i.opts.hash && (s = l(t)) && (t.currentHash = s + (1 < t.group.length ? "-" + (i.index + 1) : ""),
                r.location.hash !== "#" + t.currentHash && (n && !t.origHash && (t.origHash = r.location.hash),
                t.hashTimer && clearTimeout(t.hashTimer),
                t.hashTimer = setTimeout(function() {
                    "replaceState"in r.history ? (r.history[n ? "pushState" : "replaceState"]({}, o.title, r.location.pathname + r.location.search + "#" + t.currentHash),
                    n && (t.hasCreatedHistory = !0)) : r.location.hash = t.currentHash,
                    t.hashTimer = null
                }, 300)))
            },
...
function(e, t) {
        ...
        if (e)
            if ("string" == typeof e) {
                ...
                if (0 <= o.indexOf("<") && 0 <= o.indexOf(">")) {
                    ...
                    (r = g.createElement(a)).innerHTML = o,
                    n = 0; n < r.childNodes.length; n += 1)
                        i.push(r.childNodes[n])
                } else
                    for (s = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || g).querySelectorAll(e.trim()) : [g.getElementById(e.trim().split("#")[1])],
                    n = 0; n < s.length; n += 1)
                        s[n] && i.push(s[n])
            } else if (e.nodeType || e === re || e === g)
                i.push(e);
            ...
            function a(e) {
                ...
                if (t) {
                    ...
                    A(t).is(r))
                        ...
                        for (var n = A(t).parents(), s = 0; s < n.length; s += 1)
                            A(n[s]).is(r) && o.apply(n[s], i)
                }
            }
            function l(e) {
        ...
        off: function() {
            ...
            for (var a = n.split(" "), l = 0; l < a.length; l += 1)
                for (var c = a[l], u = 0; u < this.length; u += 1) {
                    var d = this[u]
                      , h = void 0;
                    if (!s && d.dom7Listeners ? h = d.dom7Listeners[c] : s && d.dom7LiveListeners && (h = d.dom7LiveListeners[c]),
                    h && h.length)
                        for (var p = h.length - 1; 0 <= p; p -= 1) {
                            var f = h[p];
                            r && f.listener === r ? (d.removeEventListener(c, f.proxyListener, o),
                            h.splice(p, 1)) : r && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === r ? (d.removeEventListener(c, f.proxyListener, o),
                            h.splice(p, 1)) : r || (d.removeEventListener(c, f.proxyListener, o),
                            h.splice(p, 1))
                        }
                }
            return this
            ...
            for (var i = e[0].split(" "), n = e[1], s = 0; s < i.length; s += 1)
                for (var r = i[s], o = 0; o < this.length; o += 1) {
                    ...
                    try {
                        ...
                        (l = g.createEvent("Event")).initEvent(r, !0, !0),
                        l.detail = n
                    }
        ...
        children: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var n = this[i].childNodes, s = 0; s < n.length; s += 1)
                    e ? 1 === n[s].nodeType && A(n[s]).is(e) && t.push(n[s]) : 1 === n[s].nodeType && t.push(n[s]);
            return new l(r(t))
        },
        filter: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
    ...
    var oe = {
        ...
        getTranslate: function(e, t) {
            ...
            s = new re.WebKitCSSMatrix("none" === n ? "" : n)) : i = (s = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
            "x" === t && (n = re.WebKitCSSMatrix ? s.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
            "y" === t && (n = re.WebKitCSSMatrix ? s.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
            n || 0
        },
        parseUrlQuery: function(e) {
            var t, i, n, s, r = {}, o = e || re.location.href;
            ...
            for (var i = Object(e[0]), n = 1; n < e.length; n += 1) {
                ...
                if (null != s)
                    for (var r = Object.keys(Object(s)), o = 0, a = r.length; o < a; o += 1) {
                        ...
                        void 0 !== c && c.enumerable && (oe.isObject(i[l]) && oe.isObject(s[l]) ? oe.extend(i[l], s[l]) : !oe.isObject(i[l]) && oe.isObject(s[l]) ? (i[l] = {},
                        oe.extend(i[l], s[l])) : i[l] = s[l])
                    }
            }
            return i
        }
    ...
    e.prototype.emit = function() {
        for (var e = [], t = arguments.length; t--; )
            e[t] = arguments[t];
        var i, n, s, r = this;
        return r.eventsListeners && (s = "string" == typeof e[0] || Array.isArray(e[0]) ? (i = e[0],
    ...
    var n = {
        ...
        updateSlides: function() {
            ...
            if (void 0 !== n) {
                var T, C;
                "string" == typeof b && 0 <= b.indexOf("%") && (b = parseFloat(b.replace("%", "")) / 100 * n),
                e.virtualSize = -b,
                s ? l.css({
                    marginLeft: "",
                    marginTop: ""
                ...
                for (var S, E = t.slidesPerColumn, k = T / E, $ = Math.floor(c / t.slidesPerColumn), M = 0; M < c; M += 1) {
                    ...
                    if (1 < t.slidesPerColumn) {
                        ...
                        if ("row" === t.slidesPerColumnFill && 1 < t.slidesPerGroup) {
                            ...
                            I = (A = L - (D = Math.floor(L / z)) * z + _ * t.slidesPerGroup) + D * T / E,
                            P.css({
                    ...
                    if ("none" !== P.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            t.roundLengths && (C = Math.floor(C)),
                            l[M] && (e.isHorizontal() ? l[M].style.width = C + "px" : l[M].style.height = C + "px");
                        l[M] && (l[M].swiperSlideSize = C),
                        h.push(C),
                        t.centeredSlides ? (y = y + C / 2 + w / 2 + b,
                        0 === w && 0 !== M && (y = y - n / 2 - b),
                        0 === M && (y = y - n / 2 - b),
                        Math.abs(y) < .001 && (y = 0),
                        t.roundLengths && (y = Math.floor(y)),
                        x % t.slidesPerGroup == 0 && u.push(y),
                ...
                s && r && ("slide" === t.effect || "coverflow" === t.effect) && i.css({
                ...
                1 < t.slidesPerColumn && (e.virtualSize = (C + t.spaceBetween) * T,
                ...
                if (!t.centeredSlides) {
                    ...
                    for (var J = 0; J < u.length; J += 1) {
                        ...
                        u[J] <= e.virtualSize - n && S.push(ee)
                    }
                    u = S,
                    1 < Math.floor(e.virtualSize - n) - Math.floor(u[u.length - 1]) && u.push(e.virtualSize - n)
                }
                if (0 === u.length && (u = [0]),
                0 !== t.spaceBetween && (e.isHorizontal() ? s ? l.filter(p).css({
                    marginLeft: b + "px"
                }) : l.filter(p).css({
                    marginRight: b + "px"
                }) : l.filter(p).css({
            ...
            if (0 !== n.length) {
                ...
                for (var o = 0; o < n.length; o += 1) {
                    ...
                    if (i.watchSlidesVisibility) {
                        ...
                        (0 <= c && c < t.size - 1 || 1 < u && u <= t.size || c <= 0 && u >= t.size) && (t.visibleSlides.push(a),
        ...
        updateProgress: function(e) {
            ...
            var n = t.params
              ...
              , l = o
              , c = a;
            a = 0 == s ? o = !(r = 0) : (o = (r = (e - t.minTranslate()) / s) <= 0,
            1 <= r),
            oe.extend(t, {
                progress: r,
                isBeginning: o,
        ...
        updateSlidesClasses: function() {
            var e, t = this.slides, i = this.params, n = this.$wrapperEl, s = this.activeIndex, r = this.realIndex, o = this.virtual && i.virtual.enabled;
            ...
            i.loop && (a.hasClass(i.slideDuplicateClass) ? n.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-index="' + a.attr("data-swiper-slide-index") + '"]').addClass(i.slideDuplicateNextClass) : n.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-index="' + a.attr("data-swiper-slide-index") + '"]').addClass(i.slideDuplicateNextClass),
        ...
        updateActiveIndex: function(e) {
            var t, i = this, n = i.rtlTranslate ? i.translate : -i.translate, s = i.slidesGrid, r = i.snapGrid, o = i.params, a = i.activeIndex, l = i.realIndex, c = i.snapIndex, u = e;
            if (void 0 === u) {
                for (var d = 0; d < s.length; d += 1)
                    void 0 !== s[d + 1] ? n >= s[d] && n < s[d + 1] - (s[d + 1] - s[d]) / 2 ? u = d : n >= s[d] && n < s[d + 1] && (u = d + 1) : n >= s[d] && (u = d);
    ...
    var s = {
        ...
        setTranslate: function(e, t) {
            ...
            c = Math.floor(c)),
            s.cssMode ? o[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -c : s.virtualTranslate || r.transform("translate3d(" + l + "px, " + c + "px, 0px)"),
        ...
        translateTo: function(e, t, i, n, s) {
            ...
            if (c = n && u < e ? u : n && e < d ? d : e,
            o.updateProgress(c),
            a.cssMode) {
                var h = o.isHorizontal();
                return 0 === t ? l[h ? "scrollLeft" : "scrollTop"] = -c : l.scrollTo ? l.scrollTo(((r = {})[h ? "left" : "top"] = -c,
                r.behavior = "smooth",
                r)) : l[h ? "scrollLeft" : "scrollTop"] = -c,
                !0
            }
    ...
    var o = {
        ...
        transitionEnd: function(e, t) {
            ...
            !r.cssMode) {
                i.setTransition(0);
                var o = t;
                if (o = o || (s < n ? "next" : n < s ? "prev" : "reset"),
    ...
    var a = {
        slideTo: function(e, t, i, n) {
            ...
            (d || a.initialSlide || 0) === (u || 0) && i && r.emit("beforeSlideChangeStart");
            var g, v = -l[m];
            if (r.updateProgress(v),
            a.normalizeSlideIndex)
                for (var b = 0; b < c.length; b += 1)
                    -Math.floor(100 * v) >= Math.floor(100 * c[b]) && (o = b);
            if (r.initialized && o !== d) {
                if (!r.allowSlideNext && v < r.translate && v < r.minTranslate())
                    return !1;
                if (!r.allowSlidePrev && v > r.translate && v > r.maxTranslate() && (d || 0) !== o)
                    return !1
            }
            if (g = d < o ? "next" : o < d ? "prev" : "reset",
            h && -v === r.translate || !h && v === r.translate)
                return r.updateActiveIndex(o),
                a.autoHeight && r.updateAutoHeight(),
                r.updateSlidesClasses(),
                "slide" !== a.effect && r.setTranslate(v),
                "reset" !== g && (r.transitionStart(i, g),
                r.transitionEnd(i, g)),
                !1;
            if (a.cssMode) {
                var y = r.isHorizontal();
                return 0 === t ? p[y ? "scrollLeft" : "scrollTop"] = -v : p.scrollTo ? p.scrollTo(((s = {})[y ? "left" : "top"] = -v,
                s.behavior = "smooth",
                s)) : p[y ? "scrollLeft" : "scrollTop"] = -v,
                !0
            }
            ...
            r.transitionEnd(i, g)) : (r.setTransition(t),
            r.setTranslate(v),
            r.updateActiveIndex(o),
            r.updateSlidesClasses(),
            r.emit("beforeTransitionStart", t, n),
        ...
        slidePrev: function(e, t, i) {
            ...
            var u, d = c(l ? n.translate : -n.translate), h = o.map(function(e) {
                return c(e)
            }), p = (a.map(function(e) {
                return c(e)
            }),
    ...
    var c = {
        loopCreate: function() {
            ...
            s.each(function(e, t) {
                ...
                e < s.length && e >= s.length - n.loopedSlides && a.push(t),
                i.attr("data-swiper-slide-index", e)
            });
            for (var c = 0; c < l.length; c += 1)
                t.append(A(l[c].cloneNode(!0)).addClass(e.slideDuplicateClass));
            for (var u = a.length - 1; 0 <= u; u -= 1)
                t.prepend(A(a[u].cloneNode(!0)).addClass(e.slideDuplicateClass))
        },
        loopFix: function() {
            var e = this;
            e.emit("beforeLoopFix");
            var t, i = e.activeIndex, n = e.slides, s = e.loopedSlides, r = e.allowSlidePrev, o = e.allowSlideNext, a = e.snapGrid, l = e.rtlTranslate;
            e.allowSlidePrev = !0,
            e.allowSlideNext = !0;
        ...
        addSlide: function(e, t) {
            ...
            if (e <= 0)
                ...
                for (var h = 0; h < l.length; h += 1)
                    n.append(l[h]);
                s.loop && i.loopCreate(),
                s.observer && S.observer || i.update(),
    ...
    }, P = (d = re.navigator.platform,
    h = re.navigator.userAgent,
    p = {
        ios: !1,
        android: !1,
        androidChrome: !1,
    ...
    w = !b && h.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
    ...
    $ = "MacIntel" === d,
    !b && $ && S.touch && (1024 === f && 1366 === m || 834 === f && 1194 === m || 834 === f && 1112 === m || 768 === f && 1024 === m) && (b = h.match(/(Version)\/([\d.]+)/),
    $ = !1),
    p.ie = x,
    p.edge = T,
    p.firefox = C,
    ...
    p.osVersion = v[2],
    p.android = !0,
    p.androidChrome = 0 <= h.toLowerCase().indexOf("chrome")),
    (b || w || y) && (p.os = "ios",
    p.ios = !0),
    ...
    p.ipod = !0),
    p.ios && p.osVersion && 0 <= h.indexOf("Version/") && "10" === p.osVersion.split(".")[0] && (p.osVersion = h.toLowerCase().split("version/")[1].split(" ")[0]),
    p.webView = !(!(w || b || y) || !h.match(/.*AppleWebKit(?!.*Safari)/i) && !re.navigator.standalone) || re.matchMedia && re.matchMedia("(display-mode: standalone)").matches,
    p.webview = p.webView,
    ...
    p.pixelRatio = re.devicePixelRatio || 1,
    p);
    function I() {
        var e = this
          , t = e.params
    ...
    var L, z = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = function(e) {
                    ...
                    if (!t.animating || !n.preventInteractionOnTransition) {
                        ...
                        var o = A(r.target);
                        if (("wrapper" !== n.touchEventsTarget || o.closest(t.wrapperEl).length) && (i.isTouchEvent = "touchstart" === r.type,
                        (i.isTouchEvent || !("which"in r) || 3 !== r.which) && !(!i.isTouchEvent && "button"in r && 0 < r.button || i.isTouched && i.isMoved)))
                            if (n.noSwiping && o.closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                                t.allowClick = !0;
                                ...
                                if (!c || !(a <= u || a >= re.screen.width - u)) {
                                    ...
                                    "touchstart" !== r.type) {
                                        var d = !0;
                                        o.is(i.formElements) && (d = !1),
                                        g.activeElement && A(g.activeElement).is(i.formElements) && g.activeElement !== o[0] && g.activeElement.blur();
                        ...
                        if (!i.isTouchEvent || "mousemove" !== o.type) {
                            ...
                            if (i.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                                if (t.isVertical()) {
                                    ...
                                    return;
                            if (i.isTouchEvent && g.activeElement && o.target === g.activeElement && A(o.target).is(i.formElements))
                                return i.isMoved = !0,
                                void (t.allowClick = !1);
                            ...
                            !(o.targetTouches && 1 < o.targetTouches.length)) {
                                ...
                                if (!(t.params.threshold && Math.sqrt(Math.pow(u, 2) + Math.pow(d, 2)) < t.params.threshold)) {
                                    ...
                                    if (void 0 === i.isScrolling)
                                        t.isHorizontal() && s.currentY === s.startY || t.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : 25 <= u * u + d * d && (h = 180 * Math.atan2(Math.abs(d), Math.abs(u)) / Math.PI,
                                        i.isScrolling = t.isHorizontal() ? h > n.touchAngle : 90 - h > n.touchAngle);
                ...
                e.onTouchEnd = function(e) {
                    ...
                    var u, d = oe.now(), h = d - i.touchStartTime;
                    if (t.allowClick && (t.updateClickedSlide(c),
                    t.emit("tap click", c),
                    h < 300 && d - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", c)),
                    i.lastClickTime = oe.now(),
                    oe.nextTick(function() {
                    ...
                    !n.cssMode)
                        if (n.freeMode) {
                            ...
                            if (n.freeModeMomentum) {
                                ...
                                if (y < t.maxTranslate())
                                    n.freeModeMomentumBounce ? (y + t.maxTranslate() < -C && (y = t.maxTranslate() - C),
                                    w = t.maxTranslate(),
                                    T = !0,
                                    i.allowMomentumBounce = !0) : y = t.maxTranslate(),
                                    n.loop && n.centeredSlides && (x = !0);
                                else if (y > t.minTranslate())
                                    n.freeModeMomentumBounce ? (y - t.minTranslate() > C && (y = t.minTranslate() + C),
                                    w = t.minTranslate(),
                                    T = !0,
                                ...
                                0 !== t.velocity) {
                                    if (v = r ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity),
                                    n.freeModeSticky) {
                            ...
                            for (var M = 0, P = t.slidesSizesGrid[0], I = 0; I < a.length; I += I < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                                ...
                                void 0 !== a[I + A] ? u >= a[I] && u < a[I + A] && (P = a[(M = I) + A] - a[I]) : u >= a[I] && (M = I,
                            ...
                            if (h > n.longSwipesMs) {
                                if (!n.longSwipes)
                                    return void t.slideTo(t.activeIndex);
                                "next" === t.swipeDirection && (D >= n.longSwipesRatio ? t.slideTo(M + _) : t.slideTo(M)),
                                "prev" === t.swipeDirection && (D > 1 - n.longSwipesRatio ? t.slideTo(M + _) : t.slideTo(M))
                            } else {
                                if (!n.shortSwipes)
                                    return void t.slideTo(t.activeIndex);
                                t.navigation && (c.target === t.navigation.nextEl || c.target === t.navigation.prevEl) ? c.target === t.navigation.nextEl ? t.slideTo(M + _) : t.slideTo(M) : ("next" === t.swipeDirection && t.slideTo(M + _),
                ...
                if (!S.touch && S.pointerEvents)
                    ...
                    g.addEventListener(i.move, e.onTouchMove, r),
                    ...
                    if (S.touch) {
                        ...
                        n.addEventListener(i.move, e.onTouchMove, S.passiveListener ? {
                            passive: !1,
                            capture: r
                        } : r),
                        n.addEventListener(i.end, e.onTouchEnd, o),
                        i.cancel && n.addEventListener(i.cancel, e.onTouchEnd, o),
                        D || (g.addEventListener("touchstart", _),
                        D = !0)
                    }
                    (t.simulateTouch && !P.ios && !P.android || t.simulateTouch && !S.touch && P.ios) && (n.addEventListener("mousedown", e.onTouchStart, !1),
                    g.addEventListener("mousemove", e.onTouchMove, r),
                ...
                t.updateOnWindowResize ? e.on(P.ios || P.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : e.on("observerUpdate", I, !0)
            },
            detachEvents: function() {
                ...
                if (!S.touch && S.pointerEvents)
                    ...
                    g.removeEventListener(i.move, e.onTouchMove, r),
                    ...
                    (t.simulateTouch && !P.ios && !P.android || t.simulateTouch && !S.touch && P.ios) && (n.removeEventListener("mousedown", e.onTouchStart, !1),
                    g.removeEventListener("mousemove", e.onTouchMove, r),
                ...
                e.off(P.ios || P.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I)
            }
        },
        breakpoints: {
            setBreakpoint: function() {
                ...
                if (o && (!o || 0 !== Object.keys(o).length)) {
                    ...
                    if (a && e.currentBreakpoint !== a) {
                        ...
                        u && !d ? r.removeClass(s.containerModifierClass + "multirow " + s.containerModifierClass + "multirow-column") : !u && d && (r.addClass(s.containerModifierClass + "multirow"),
        ...
        classes: {
            addClasses: function() {
                ...
                "column" === i.slidesPerColumnFill && s.push("multirow-column")),
                P.android && s.push("android"),
                P.ios && s.push("ios"),
        ...
        images: {
            loadImage: function(e, t, i, n, s, r) {
                ...
                e.complete && s ? a() : t ? ((o = new re.Image).onload = a,
                o.onerror = a,
                n && (o.sizes = n),
                i && (o.srcset = i),
                t && (o.src = t)) : a()
        ...
        function p() {
            for (var e, t, s, i = [], n = arguments.length; n--; )
                i[n] = arguments[n];
            s = (s = 1 === i.length && i[0].constructor && i[0].constructor === Object ? i[0] : (t = (e = i)[0],
            e[1])) || {},
            s = oe.extend({}, s),
            t && !s.el && (s.el = t),
            h.call(this, s),
            ...
            r.params = oe.extend({}, o, N, s),
            r.originalParams = oe.extend({}, r.params),
            r.passedParams = oe.extend({}, s);
            ...
            if (t = a[0]) {
                ...
                return t.swiper = r,
                a.data("swiper", r),
                t && t.shadowRoot && t.shadowRoot.querySelector ? (c = A(t.shadowRoot.querySelector("." + r.params.wrapperClass))).children = function(e) {
                    return a.children(e)
                }
                : c = a.children("." + r.params.wrapperClass),
                oe.extend(r, {
                    $el: a,
                    el: t,
                    $wrapperEl: c,
                    ...
                    S.pointerEvents && (d = ["pointerdown", "pointermove", "pointerup"]),
                    r.touchEventsTouch = {
                        start: u[0],
                        move: u[1],
                        end: u[2],
        ...
        return ((p.prototype = Object.create(h && h.prototype)).constructor = p).prototype.slidesPerViewDynamic = function() {
            var e = this.params
              ...
              , r = 1;
            if (e.centeredSlides) {
                for (var o, a = t[s].swiperSlideSize, l = s + 1; l < t.length; l += 1)
                    t[l] && !o && (r += 1,
                    n < (a += t[l].swiperSlideSize) && (o = !0));
                for (var c = s - 1; 0 <= c; c -= 1)
                    t[c] && !o && (r += 1,
                    n < (a += t[c].swiperSlideSize) && (o = !0))
            } else
        ...
        isSafari: (L = re.navigator.userAgent.toLowerCase(),
        ...
        on: {
            init: function() {
                ...
                re.addEventListener("orientationchange", this.resize.orientationChangeHandler)
            },
            destroy: function() {
                re.removeEventListener("resize", this.resize.resizeHandler),
                re.removeEventListener("orientationchange", this.resize.orientationChangeHandler)
            }
        }
    }, V = {
        ...
        update: function(e) {
            ...
            b = r ? (v = Math.floor(n / 2) + s + a,
            Math.floor(n / 2) + s + l) : (v = n + (s - 1) + a,
            s + l);
            ...
            for (var $ = 0; $ < h.length; $ += 1)
                w <= $ && $ <= x && (void 0 === d || e ? E.push($) : (d < $ && E.push($),
                $ < u && S.push($)));
            E.forEach(function(e) {
        ...
        on: {
            beforeInit: function() {
                if (this.params.virtual.enabled) {
                    ...
                    oe.extend(this.params, e),
                    oe.extend(this.originalParams, e),
        ...
        handle: function(e) {
            ...
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || g.activeElement && g.activeElement.nodeName && ("input" === g.activeElement.nodeName.toLowerCase() || "textarea" === g.activeElement.nodeName.toLowerCase()))) {
                ...
                t.isHorizontal() ? (33 !== s && 34 !== s && 37 !== s && 39 !== s || (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                (34 !== s && 39 !== s || i) && (33 !== s && 37 !== s || !i) || t.slideNext(),
                (33 !== s && 37 !== s || i) && (34 !== s && 39 !== s || !i) || t.slidePrev()) : (33 !== s && 34 !== s && 38 !== s && 40 !== s || (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
        ...
        enable: function() {
            this.keyboard.enabled || (A(g).on("keydown", this.keyboard.handle),
            this.keyboard.enabled = !0)
        },
        disable: function() {
            this.keyboard.enabled && (A(g).off("keydown", this.keyboard.handle),
    ...
    var K = {
        ...
        handle: function(e) {
            ...
            var s = i.$el;
            if ("container" !== i.params.mousewheel.eventsTarged && (s = A(i.params.mousewheel.eventsTarged)),
            ...
            if (n.forceToAxis)
                ...
                r = Math.abs(a.pixelX) > Math.abs(a.pixelY) ? -a.pixelX * o : -a.pixelY;
            if (0 === r)
                return !0;
            if (n.invert && (r = -r),
            i.params.freeMode) {
                ...
                if (!u) {
                    ...
                    i.params.freeModeSticky) {
                        ...
                        m && (l.delta > m.delta || l.direction !== m.direction))
                            ...
                            f.splice(0),
                            i.mousewheel.timeout = oe.nextTick(function() {
                ...
                if (y.push(b),
                w ? (b.direction !== w.direction || b.delta > w.delta) && i.mousewheel.animateSlider(b) : i.mousewheel.animateSlider(b),
        ...
        animateSlider: function(e) {
            var t = this;
            return 6 <= e.delta && oe.now() - t.mousewheel.lastScrollTime < 60 || (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(),
      ...
      , Q = {
        update: function() {
            ...
            if (s.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                var r, i = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length, n = e.pagination.$el, o = e.params.loop ? Math.ceil((i - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length;
                ...
                "bullets" === s.type && e.pagination.bullets && 0 < e.pagination.bullets.length) {
                    ...
                    if (s.dynamicBullets && (e.pagination.bulletSize = u.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    ...
                    c = ((l = a + (Math.min(u.length, s.dynamicMainBullets) - 1)) + a) / 2),
                    u.removeClass(s.bulletActiveClass + " " + s.bulletActiveClass + "-next " + s.bulletActiveClass + "-next-next " + s.bulletActiveClass + "-prev " + s.bulletActiveClass + "-prev-prev " + s.bulletActiveClass + "-main"),
                    1 < n.length)
                        u.each(function(e, t) {
                            var i = A(t)
                              , n = i.index();
                            n === r && i.addClass(s.bulletActiveClass),
                            s.dynamicBullets && (a <= n && n <= l && i.addClass(s.bulletActiveClass + "-main"),
                            n === a && i.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"),
                            n === l && i.next().addClass(s.bulletActiveClass + "-next").next().addClass(s.bulletActiveClass + "-next-next"))
                        });
                    else {
                        var d = u.eq(r)
                          , h = d.index();
                        if (d.addClass(s.bulletActiveClass),
                        s.dynamicBullets) {
                            for (var p = u.eq(a), f = u.eq(l), m = a; m <= l; m += 1)
                                u.eq(m).addClass(s.bulletActiveClass + "-main");
                            if (e.params.loop)
                                if (h >= u.length - s.dynamicMainBullets) {
                                    for (var g = s.dynamicMainBullets; 0 <= g; g -= 1)
                                        u.eq(u.length - g).addClass(s.bulletActiveClass + "-main");
                                    u.eq(u.length - s.dynamicMainBullets - 1).addClass(s.bulletActiveClass + "-prev")
                                } else
                                    p.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"),
                                    f.next().addClass(s.bulletActiveClass + "-next").next().addClass(s.bulletActiveClass + "-next-next");
                            else
                                p.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(s.bulletActiveClass + "-prev-prev"),
                                f.next().addClass(s.bulletActiveClass + "-next").next().addClass(s.bulletActiveClass + "-next-next")
                        }
                ...
                "progressbar" === s.type) {
                    ...
                    n.find("." + s.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + C + ")").transition(e.params.speed)
                }
      ...
      , J = {
        ...
        updateSize: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                ...
                i[0].style.width = "",
                i[0].style.height = "";
                var s, r = e.isHorizontal() ? n[0].offsetWidth : n[0].offsetHeight, o = e.size / e.virtualSize, a = o * (r / e.size);
                s = "auto" === e.params.scrollbar.dragSize ? r * o : parseInt(e.params.scrollbar.dragSize, 10),
        ...
        setDragPosition: function(e) {
            var t, i = this, n = i.scrollbar, s = i.rtlTranslate, r = n.$el, o = n.dragSize, a = n.trackSize, l = n.dragStartPos;
            t = (n.getPointerPosition(e) - r.offset()[i.isHorizontal() ? "left" : "top"] - (null !== l ? l : o / 2)) / (a - o),
        ...
        enableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                S.touch ? (r.addEventListener(i.start, e.scrollbar.onDragStart, o),
                r.addEventListener(i.move, e.scrollbar.onDragMove, o),
                r.addEventListener(i.end, e.scrollbar.onDragEnd, a)) : (r.addEventListener(n.start, e.scrollbar.onDragStart, o),
                g.addEventListener(n.move, e.scrollbar.onDragMove, o),
                g.addEventListener(n.end, e.scrollbar.onDragEnd, a))
            }
        },
        disableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                S.touch ? (r.removeEventListener(i.start, e.scrollbar.onDragStart, o),
                r.removeEventListener(i.move, e.scrollbar.onDragMove, o),
                r.removeEventListener(i.end, e.scrollbar.onDragEnd, a)) : (r.removeEventListener(n.start, e.scrollbar.onDragStart, o),
                g.removeEventListener(n.move, e.scrollbar.onDragMove, o),
                g.removeEventListener(n.end, e.scrollbar.onDragEnd, a))
            }
        },
        init: function() {
            if (this.params.scrollbar.el) {
                ...
                0 === s.length && (s = A('<div class="' + this.params.scrollbar.dragClass + '"></div>'),
                n.append(s)),
                oe.extend(e, {
                    $el: n,
                    el: n[0],
      ...
      , ee = {
        ...
        setTranslate: function() {
            ...
            t.each(function(e, t) {
                var i = t.progress;
                1 < n.params.slidesPerGroup && "auto" !== n.params.slidesPerView && (i += Math.ceil(e / 2) - s * (r.length - 1)),
                i = Math.min(Math.max(i, -1), 1),
                A(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(e, t) {
      ...
      , te = {
        ...
        onGestureChange: function(e) {
            ...
            n.$imageEl && 0 !== n.$imageEl.length && (i.scale = S.gestures ? e.scale * i.currentScale : n.scaleMove / n.scaleStart * i.currentScale,
        ...
        onTouchStart: function(e) {
            var t = this.zoom
              , i = t.gesture
              , n = t.image;
            i.$imageEl && 0 !== i.$imageEl.length && (n.isTouched || (P.android && e.preventDefault(),
            n.isTouched = !0,
        ...
        onTouchMove: function(e) {
            ...
            n.isTouched && i.$slideEl)) {
                ...
                n.startX = oe.getTranslate(i.$imageWrapEl[0], "x") || 0,
                n.startY = oe.getTranslate(i.$imageWrapEl[0], "y") || 0,
        ...
        onTouchEnd: function() {
            ...
            if (t.$imageEl && 0 !== t.$imageEl.length) {
                ...
                var s = 300
                  ...
                  , l = n.y * r
                  , c = i.currentY + l;
                0 !== n.x && (s = Math.abs((a - i.currentX) / n.x)),
        ...
        in: function(e) {
            var t, i, n, s, r, o, a, l, c, u, d, h, p, f, m, g, v = this.zoom, b = this.params.zoom, y = v.gesture, w = v.image;
            y.$slideEl || (y.$slideEl = this.clickedSlide ? A(this.clickedSlide) : this.slides.eq(this.activeIndex),
        ...
        out: function() {
            var e = this.zoom
              , t = this.params.zoom
              , i = e.gesture;
            i.$slideEl || (i.$slideEl = this.clickedSlide ? A(this.clickedSlide) : this.slides.eq(this.activeIndex),
        ...
        enable: function() {
            ...
            if (!t.enabled) {
                ...
                S.gestures ? (e.$wrapperEl.on("gesturestart", ".swiper-slide", t.onGestureStart, i),
        ...
        disable: function() {
            ...
            if (t.enabled) {
                ...
                S.gestures ? (e.$wrapperEl.off("gesturestart", ".swiper-slide", t.onGestureStart, i),
      ...
      , ie = {
        ...
        load: function() {
            ...
            n.params.watchSlidesVisibility)
                ...
                for (var u = e; u < e + a; u += 1)
                    l(u) && n.lazy.loadInSlide(u);
            else
                n.lazy.loadInSlide(e);
            if (o.loadPrevNext)
                if (1 < a || o.loadPrevNextAmount && 1 < o.loadPrevNextAmount) {
                    for (var d = o.loadPrevNextAmount, h = a, p = Math.min(e + h + Math.max(d, h), s.length), f = Math.max(e - Math.max(h, d), 0), m = e + a; m < p; m += 1)
      ...
      , ne = {
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(r))
                for (var a = 0; a < r.length; a += 1)
                    r[a] !== t && r[a]instanceof H && o(r[a]);
            else
                r instanceof H && t !== r && o(r)
        },
        setTransition: function(t, e) {
            ...
            function r(e) {
                ...
                e.params.autoHeight && oe.nextTick(function() {
                    e.updateAutoHeight()
                }),
            ...
            if (Array.isArray(s))
                for (i = 0; i < s.length; i += 1)
                    s[i] !== e && s[i]instanceof H && r(s[i]);
            else
                s instanceof H && e !== s && r(s)
        }
    }
      , se = {
        ...
        updatePagination: function() {
            ...
            n.pagination && n.params.pagination.clickable && n.pagination.bullets && n.pagination.bullets.length && n.pagination.bullets.each(function(e, t) {
                ...
                n.a11y.addElLabel(i, s.paginationBulletMessage.replace(/{{index}}/, i.index() + 1))
            })
        },
        init: function() {
            var e = this;
      ...
      , ae = {
        init: function() {
            if (this.params.history) {
                ...
                this.params.history.replaceState || re.addEventListener("popstate", this.history.setHistoryPopState))
            }
        },
        destroy: function() {
      ...
      , le = {
        ...
        setHash: function() {
            if (this.hashNavigation.initialized && this.params.hashNavigation.enabled)
                if (this.params.hashNavigation.replaceState && re.history && re.history.replaceState)
                    re.history.replaceState(null, null, "#" + this.slides.eq(this.activeIndex).attr("data-hash") || "");
                else {
      ...
      , ce = {
        run: function() {
            ...
            e.autoplay.timeout = oe.nextTick(function() {
      ...
      , de = {
        setTranslate: function() {
            var e, t = this, i = t.$el, n = t.$wrapperEl, s = t.slides, r = t.width, o = t.height, a = t.rtlTranslate, l = t.size, c = t.params.cubeEffect, u = t.isHorizontal(), d = t.virtual && t.params.virtual.enabled, h = 0;
            c.shadow && (u ? (0 === (e = n.find(".swiper-cube-shadow")).length && (e = A('<div class="swiper-cube-shadow"></div>'),
            n.append(e)),
            e.css({
                height: r + "px"
            })) : 0 === (e = i.find(".swiper-cube-shadow")).length && (e = A('<div class="swiper-cube-shadow"></div>'),
            i.append(e)));
            for (var p = 0; p < s.length; p += 1) {
                ...
                c.slideShadows) {
                    ...
                    0 === C.length && (C = A('<div class="swiper-slide-shadow-' + (u ? "left" : "top") + '"></div>'),
                    f.append(C)),
                    0 === S.length && (S = A('<div class="swiper-slide-shadow-' + (u ? "right" : "bottom") + '"></div>'),
                    f.append(S)),
        ...
        setTranslate: function() {
            for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                ...
                var r = -180 * s
                  ...
                  , l = 0;
                if (this.isHorizontal() ? t && (r = -r) : (l = a,
                o = -r,
                r = a = 0),
                ...
                this.params.flipEffect.slideShadows) {
                    ...
                    n.append(c)),
                    0 === u.length && (u = A('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    n.append(u)),
        ...
        setTranslate: function() {
            for (var e = this.width, t = this.height, i = this.slides, n = this.$wrapperEl, s = this.slidesSizesGrid, r = this.params.coverflowEffect, o = this.isHorizontal(), a = this.translate, l = o ? e / 2 - a : t / 2 - a, c = o ? r.rotate : -r.rotate, u = r.depth, d = 0, h = i.length; d < h; d += 1) {
                ...
                r.slideShadows) {
                    ...
                    0 === T.length && (T = A('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'),
                    p.append(T)),
                    0 === C.length && (C = A('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'),
                    p.append(C)),
      ...
      , fe = {
        init: function() {
            ...
            oe.extend(e.thumbs.swiper.originalParams, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1
            }),
            ...
            if (i) {
                ...
                if (t.realIndex !== i.realIndex) {
                    ...
                    if (i.params.loop) {
                        ...
                        s = t.realIndex;
                    i.visibleSlidesIndexes && i.visibleSlidesIndexes.indexOf(s) < 0 && (i.params.centeredSlides ? s = r < s ? s - Math.floor(n / 2) + 1 : s + Math.floor(n / 2) - 1 : r < s && (s = s - n + 1),
      ...
      , me = [B, F, q, R, W, X, U, {
        ...
        on: {
            ...
            click: function(e) {
                var t, i = this, n = i.navigation, s = n.$nextEl, r = n.$prevEl;
                !i.params.navigation.hideOnClick || A(e.target).is(r) || A(e.target).is(s) || (s ? t = s.hasClass(i.params.navigation.hiddenClass) : r && (t = r.hasClass(i.params.navigation.hiddenClass)),
        ...
        on: {
            ...
            click: function(e) {
                var t = this;
                t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !A(e.target).hasClass(t.params.pagination.bulletClass) && (!0 === t.pagination.$el.hasClass(t.params.pagination.hiddenClass) ? t.emit("paginationShow", t) : t.emit("paginationHide", t),
...
function(e, t) {
    ...
    e.prototype.activateItem = function(t) {
        var i = this
          ...
          , s = e.callback;
        if (!t)
            return this.scrollItems.forEach(function(e) {
                return o(e.elm.parentNode, n)
            }),
            this.lastInViewElm = null,
            void (this.options.enableLocationHash && this.debouncedHashFn());
        this.lastInViewElm !== t.target && (this.lastInViewElm = t.target,
        this.scrollItems.forEach(function(e) {
            o(e.elm.parentNode, n),
            e.target === t.target && (r(e.elm.parentNode, n),
            "function" == typeof s && s.call(i, e),
            i.options.enableLocationHash && i.debouncedHashFn())
        }))
    }
    ,
    e.prototype.scrollFn = function() {
        var e = s();
        this.currScrollTop !== e && (this.currScrollTop = e,
        this.tick()),
